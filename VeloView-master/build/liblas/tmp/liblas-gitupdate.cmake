...
execute_process(
  COMMAND "/usr/bin/git" show-ref fix-windows-stdint
  WORKING_DIRECTORY "/home/marko/research/VeloView-master/build/liblas/src/liblas"
...
if("${show_ref_output}" MATCHES "refs/remotes/fix-windows-stdint")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "fix-windows-stdint")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "fix-windows-stdint")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 fix-windows-stdint
  WORKING_DIRECTORY "/home/marko/research/VeloView-master/build/liblas/src/liblas"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git://github.com/mwoehlke-kitware/libLAS.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/marko/research/VeloView-master/build/liblas/src/liblas/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/marko/research/VeloView-master/build/liblas/src/liblas/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
