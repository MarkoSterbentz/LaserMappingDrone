...
execute_process(
  COMMAND "/usr/bin/git" show-ref patched-3
  WORKING_DIRECTORY "/home/marko/research/VeloView-master/build/pythonqt/src/pythonqt"
...
if("${show_ref_output}" MATCHES "refs/remotes/patched-3")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "patched-3")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "patched-3")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 patched-3
  WORKING_DIRECTORY "/home/marko/research/VeloView-master/build/pythonqt/src/pythonqt"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git://github.com/commontk/PythonQt.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/marko/research/VeloView-master/build/pythonqt/src/pythonqt/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/marko/research/VeloView-master/build/pythonqt/src/pythonqt/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
