...
execute_process(
  COMMAND "/usr/bin/git" show-ref origin/veloview
  WORKING_DIRECTORY "/home/marko/research/VeloView-master/build/paraview/src/paraview"
...
if("${show_ref_output}" MATCHES "refs/remotes/origin/veloview")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "origin/veloview")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "origin/veloview")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 origin/veloview
  WORKING_DIRECTORY "/home/marko/research/VeloView-master/build/paraview/src/paraview"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git://github.com/gcasey/ParaView.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/marko/research/VeloView-master/build/paraview/src/paraview/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/marko/research/VeloView-master/build/paraview/src/paraview/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
