// ClientServer wrapper for vtkPointHandleRepresentationSphere object
//
...
vtkObjectBase *vtkPointHandleRepresentationSphereClientServerNewCommand(void* /*ctx*/)
{
  return vtkPointHandleRepresentationSphere::New();
}


int VTK_EXPORT vtkPointHandleRepresentationSphereCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPointHandleRepresentationSphere *op = vtkPointHandleRepresentationSphere::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPointHandleRepresentationSphere.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPointHandleRepresentationSphere  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("SetScalar",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetScalar",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
      temp20 = (op)->GetScalar();
  ...
  if (!strcmp("SetAddCircleAroundSphere",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetAddCircleAroundSphere",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetAddCircleAroundSphere();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("AddCircleAroundSphereOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("AddCircleAroundSphereOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPointHandleRepresentationSphere, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPointHandleRepresentationSphere_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPointHandleRepresentationSphere", vtkPointHandleRepresentationSphereClientServerNewCommand);
    csi->AddCommandFunction("vtkPointHandleRepresentationSphere", vtkPointHandleRepresentationSphereCommand);
    }
}
