// ClientServer wrapper for vtkUnsignedCharArray object
//
...
vtkObjectBase *vtkUnsignedCharArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkUnsignedCharArray::New();
}


int VTK_EXPORT vtkUnsignedCharArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkUnsignedCharArray *op = vtkUnsignedCharArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkUnsignedCharArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkUnsignedCharArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkUnsignedCharArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkUnsignedCharArray", vtkUnsignedCharArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkUnsignedCharArray", vtkUnsignedCharArrayCommand);
    }
}
