// ClientServer wrapper for vtkRectilinearSynchronizedTemplates object
//
...
vtkObjectBase *vtkRectilinearSynchronizedTemplatesClientServerNewCommand(void* /*ctx*/)
{
  return vtkRectilinearSynchronizedTemplates::New();
}


int VTK_EXPORT vtkRectilinearSynchronizedTemplatesCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkRectilinearSynchronizedTemplates *op = vtkRectilinearSynchronizedTemplates::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkRectilinearSynchronizedTemplates.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkRectilinearSynchronizedTemplates  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkRectilinearSynchronizedTemplates, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkRectilinearSynchronizedTemplates_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkRectilinearSynchronizedTemplates", vtkRectilinearSynchronizedTemplatesClientServerNewCommand);
    csi->AddCommandFunction("vtkRectilinearSynchronizedTemplates", vtkRectilinearSynchronizedTemplatesCommand);
    }
}
