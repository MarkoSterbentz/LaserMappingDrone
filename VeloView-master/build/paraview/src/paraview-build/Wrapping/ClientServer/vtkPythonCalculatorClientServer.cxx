// ClientServer wrapper for vtkPythonCalculator object
//
...
vtkObjectBase *vtkPythonCalculatorClientServerNewCommand(void* /*ctx*/)
{
  return vtkPythonCalculator::New();
}


int VTK_EXPORT vtkPythonCalculatorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPythonCalculator *op = vtkPythonCalculator::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPythonCalculator.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPythonCalculator, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPythonCalculator_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPythonCalculator", vtkPythonCalculatorClientServerNewCommand);
    csi->AddCommandFunction("vtkPythonCalculator", vtkPythonCalculatorCommand);
    }
}
