// ClientServer wrapper for vtkTableToStructuredGrid object
//
...
vtkObjectBase *vtkTableToStructuredGridClientServerNewCommand(void* /*ctx*/)
{
  return vtkTableToStructuredGrid::New();
}


int VTK_EXPORT vtkTableToStructuredGridCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkTableToStructuredGrid *op = vtkTableToStructuredGrid::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkTableToStructuredGrid.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkTableToStructuredGrid  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkTableToStructuredGrid, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkTableToStructuredGrid_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkTableToStructuredGrid", vtkTableToStructuredGridClientServerNewCommand);
    csi->AddCommandFunction("vtkTableToStructuredGrid", vtkTableToStructuredGridCommand);
    }
}
