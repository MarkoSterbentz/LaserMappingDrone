// ClientServer wrapper for vtkGridTransform object
//
...
vtkObjectBase *vtkGridTransformClientServerNewCommand(void* /*ctx*/)
{
  return vtkGridTransform::New();
}


int VTK_EXPORT vtkGridTransformCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkGridTransform *op = vtkGridTransform::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkGridTransform.  "
  ...
  if (!strcmp("SetDisplacementGridConnection",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  if (!strcmp("SetDisplacementGridData",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkImageData  *temp0;
  ...
  if (!strcmp("GetDisplacementGrid",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkImageData  *temp20;
      {
  ...
  if (!strcmp("SetDisplacementShift",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkGridTransform, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkGridTransform_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkGridTransform", vtkGridTransformClientServerNewCommand);
    csi->AddCommandFunction("vtkGridTransform", vtkGridTransformCommand);
    }
}
