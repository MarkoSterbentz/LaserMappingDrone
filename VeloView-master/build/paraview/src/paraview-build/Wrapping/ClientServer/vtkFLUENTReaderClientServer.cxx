// ClientServer wrapper for vtkFLUENTReader object
//
...
vtkObjectBase *vtkFLUENTReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkFLUENTReader::New();
}


int VTK_EXPORT vtkFLUENTReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkFLUENTReader *op = vtkFLUENTReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkFLUENTReader.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkFLUENTReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkFLUENTReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkFLUENTReader", vtkFLUENTReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkFLUENTReader", vtkFLUENTReaderCommand);
    }
}
