// ClientServer wrapper for vtkImageActor object
//
...
vtkObjectBase *vtkImageActorClientServerNewCommand(void* /*ctx*/)
{
  return vtkImageActor::New();
}


int VTK_EXPORT vtkImageActorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkImageActor *op = vtkImageActor::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkImageActor.  "
  ...
  if (!strcmp("SetDisplayExtent",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[6];
  ...
  if (!strcmp("SetDisplayExtent",method) && msg.GetNumberOfArguments(0) == 8)
    {
    int      temp0;
    int      temp1;
    int      temp2;
  ...
  if (!strcmp("GetDisplayExtent",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[6];
    if(msg.GetArgument(0, 2, temp0, 6))
      {
  ...
  if (!strcmp("GetDisplayExtent",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
  ...
  if (!strcmp("GetDisplayBounds",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[6];
    if(msg.GetArgument(0, 2, temp0, 6))
      {
  ...
  if (!strcmp("GetSliceNumberMax",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetSliceNumberMin",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  {
    const char* commandName = "vtkImageSlice";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkImageActor, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkImageActor_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkImageActor", vtkImageActorClientServerNewCommand);
    csi->AddCommandFunction("vtkImageActor", vtkImageActorCommand);
    }
}
