// ClientServer wrapper for vtkQuadraticTriangle object
//
...
vtkObjectBase *vtkQuadraticTriangleClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticTriangle::New();
}


int VTK_EXPORT vtkQuadraticTriangleCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticTriangle *op = vtkQuadraticTriangle::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticTriangle.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticTriangle, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticTriangle_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticTriangle", vtkQuadraticTriangleClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticTriangle", vtkQuadraticTriangleCommand);
    }
}
