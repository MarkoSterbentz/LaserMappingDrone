// ClientServer wrapper for vtkQuadraticWedge object
//
...
vtkObjectBase *vtkQuadraticWedgeClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticWedge::New();
}


int VTK_EXPORT vtkQuadraticWedgeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticWedge *op = vtkQuadraticWedge::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticWedge.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticWedge, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticWedge_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticWedge", vtkQuadraticWedgeClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticWedge", vtkQuadraticWedgeCommand);
    }
}
