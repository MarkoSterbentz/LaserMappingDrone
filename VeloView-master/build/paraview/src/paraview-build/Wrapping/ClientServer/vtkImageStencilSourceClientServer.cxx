// ClientServer wrapper for vtkImageStencilSource object
//
...
vtkObjectBase *vtkImageStencilSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkImageStencilSource::New();
}


int VTK_EXPORT vtkImageStencilSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkImageStencilSource *op = vtkImageStencilSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkImageStencilSource.  "
  ...
  if (!strcmp("SetOutputWholeExtent",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[6];
  ...
  {
    const char* commandName = "vtkImageStencilAlgorithm";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkImageStencilSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkImageStencilSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkImageStencilSource", vtkImageStencilSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkImageStencilSource", vtkImageStencilSourceCommand);
    }
}
