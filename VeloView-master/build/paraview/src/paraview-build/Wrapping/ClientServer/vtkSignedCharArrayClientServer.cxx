// ClientServer wrapper for vtkSignedCharArray object
//
...
vtkObjectBase *vtkSignedCharArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkSignedCharArray::New();
}


int VTK_EXPORT vtkSignedCharArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSignedCharArray *op = vtkSignedCharArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSignedCharArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSignedCharArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSignedCharArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSignedCharArray", vtkSignedCharArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkSignedCharArray", vtkSignedCharArrayCommand);
    }
}
