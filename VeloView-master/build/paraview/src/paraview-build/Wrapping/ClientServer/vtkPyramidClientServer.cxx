// ClientServer wrapper for vtkPyramid object
//
...
vtkObjectBase *vtkPyramidClientServerNewCommand(void* /*ctx*/)
{
  return vtkPyramid::New();
}


int VTK_EXPORT vtkPyramidCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPyramid *op = vtkPyramid::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPyramid.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPyramid, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPyramid_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPyramid", vtkPyramidClientServerNewCommand);
    csi->AddCommandFunction("vtkPyramid", vtkPyramidCommand);
    }
}
