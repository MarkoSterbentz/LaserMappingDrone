// ClientServer wrapper for vtkDataSetSurfaceFilter object
//
...
vtkObjectBase *vtkDataSetSurfaceFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkDataSetSurfaceFilter::New();
}


int VTK_EXPORT vtkDataSetSurfaceFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDataSetSurfaceFilter *op = vtkDataSetSurfaceFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDataSetSurfaceFilter.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkDataSetSurfaceFilter  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("StructuredExecute",method) && msg.GetNumberOfArguments(0) == 6)
    {
    vtkDataSet  *temp0;
    vtkPolyData  *temp1;
    ...
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkDataSet") &&
      ...
      temp3)
      {
      temp20 = (op)->StructuredExecute(temp0,temp1,temp2,temp3);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("UnstructuredGridExecute",method) && msg.GetNumberOfArguments(0) == 5)
    {
    vtkDataSet  *temp0;
    vtkPolyData  *temp1;
    int      temp2;
    ...
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkDataSet") &&
      ...
      {
      temp20 = (op)->UnstructuredGridExecute(temp0,temp1,temp2);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("DataSetExecute",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkDataSet  *temp0;
    vtkPolyData  *temp1;
    int      temp20;
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDataSetSurfaceFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDataSetSurfaceFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDataSetSurfaceFilter", vtkDataSetSurfaceFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkDataSetSurfaceFilter", vtkDataSetSurfaceFilterCommand);
    }
}
