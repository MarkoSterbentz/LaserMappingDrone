// ClientServer wrapper for vtkPointLocator object
//
...
vtkObjectBase *vtkPointLocatorClientServerNewCommand(void* /*ctx*/)
{
  return vtkPointLocator::New();
}


int VTK_EXPORT vtkPointLocatorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPointLocator *op = vtkPointLocator::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPointLocator.  "
  ...
  if (!strcmp("SetNumberOfPointsPerBucket",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetNumberOfPointsPerBucketMinValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetNumberOfPointsPerBucketMaxValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetNumberOfPointsPerBucket",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("FindDistributedPoints",method) && msg.GetNumberOfArguments(0) == 8)
    {
    int      temp0;
    double   temp1;
    double   temp2;
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPointLocator, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPointLocator_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPointLocator", vtkPointLocatorClientServerNewCommand);
    csi->AddCommandFunction("vtkPointLocator", vtkPointLocatorCommand);
    }
}
