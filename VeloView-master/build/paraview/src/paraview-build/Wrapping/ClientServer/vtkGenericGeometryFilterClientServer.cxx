// ClientServer wrapper for vtkGenericGeometryFilter object
//
...
vtkObjectBase *vtkGenericGeometryFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkGenericGeometryFilter::New();
}


int VTK_EXPORT vtkGenericGeometryFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkGenericGeometryFilter *op = vtkGenericGeometryFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkGenericGeometryFilter.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkGenericGeometryFilter  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkGenericGeometryFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkGenericGeometryFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkGenericGeometryFilter", vtkGenericGeometryFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkGenericGeometryFilter", vtkGenericGeometryFilterCommand);
    }
}
