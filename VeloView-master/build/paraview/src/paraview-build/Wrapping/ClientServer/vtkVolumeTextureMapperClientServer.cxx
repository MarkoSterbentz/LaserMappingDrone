// ClientServer wrapper for vtkVolumeTextureMapper object
//
...
int VTK_EXPORT vtkVolumeTextureMapperCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkVolumeTextureMapper *op = vtkVolumeTextureMapper::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkVolumeTextureMapper.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkVolumeTextureMapper, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkVolumeTextureMapper_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkVolumeTextureMapper", vtkVolumeTextureMapperCommand);
    }
}
