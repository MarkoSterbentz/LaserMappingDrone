// ClientServer wrapper for vtkUnsignedLongArray object
//
...
vtkObjectBase *vtkUnsignedLongArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkUnsignedLongArray::New();
}


int VTK_EXPORT vtkUnsignedLongArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkUnsignedLongArray *op = vtkUnsignedLongArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkUnsignedLongArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkUnsignedLongArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkUnsignedLongArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkUnsignedLongArray", vtkUnsignedLongArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkUnsignedLongArray", vtkUnsignedLongArrayCommand);
    }
}
