// ClientServer wrapper for vtkPVCameraKeyFrame object
//
...
vtkObjectBase *vtkPVCameraKeyFrameClientServerNewCommand(void* /*ctx*/)
{
  return vtkPVCameraKeyFrame::New();
}


int VTK_EXPORT vtkPVCameraKeyFrameCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPVCameraKeyFrame *op = vtkPVCameraKeyFrame::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPVCameraKeyFrame.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPVCameraKeyFrame, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPVCameraKeyFrame_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPVCameraKeyFrame", vtkPVCameraKeyFrameClientServerNewCommand);
    csi->AddCommandFunction("vtkPVCameraKeyFrame", vtkPVCameraKeyFrameCommand);
    }
}
