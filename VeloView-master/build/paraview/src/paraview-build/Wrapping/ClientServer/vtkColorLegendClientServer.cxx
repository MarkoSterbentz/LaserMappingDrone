// ClientServer wrapper for vtkColorLegend object
//
...
vtkObjectBase *vtkColorLegendClientServerNewCommand(void* /*ctx*/)
{
  return vtkColorLegend::New();
}


int VTK_EXPORT vtkColorLegendCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkColorLegend *op = vtkColorLegend::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkColorLegend.  "
  ...
  if (!strcmp("SetTextureSize",method) && msg.GetNumberOfArguments(0) == 4)
    {
    float    temp0;
    float    temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetDrawBorder",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetDrawBorder",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetDrawBorder();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("DrawBorderOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->DrawBorderOn();
      return 1;
  ...
  if (!strcmp("DrawBorderOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->DrawBorderOff();
      return 1;
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkColorLegend, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkColorLegend_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkColorLegend", vtkColorLegendClientServerNewCommand);
    csi->AddCommandFunction("vtkColorLegend", vtkColorLegendCommand);
    }
}
