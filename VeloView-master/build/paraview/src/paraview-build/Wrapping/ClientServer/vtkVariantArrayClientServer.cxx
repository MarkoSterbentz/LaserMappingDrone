// ClientServer wrapper for vtkVariantArray object
//
...
vtkObjectBase *vtkVariantArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkVariantArray::New();
}


int VTK_EXPORT vtkVariantArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkVariantArray *op = vtkVariantArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkVariantArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkVariantArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkVariantArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkVariantArray", vtkVariantArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkVariantArray", vtkVariantArrayCommand);
    }
}
