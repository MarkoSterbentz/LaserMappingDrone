// ClientServer wrapper for vtkDistanceRepresentation2D object
//
...
vtkObjectBase *vtkDistanceRepresentation2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkDistanceRepresentation2D::New();
}


int VTK_EXPORT vtkDistanceRepresentation2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDistanceRepresentation2D *op = vtkDistanceRepresentation2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDistanceRepresentation2D.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDistanceRepresentation2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDistanceRepresentation2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDistanceRepresentation2D", vtkDistanceRepresentation2DClientServerNewCommand);
    csi->AddCommandFunction("vtkDistanceRepresentation2D", vtkDistanceRepresentation2DCommand);
    }
}
