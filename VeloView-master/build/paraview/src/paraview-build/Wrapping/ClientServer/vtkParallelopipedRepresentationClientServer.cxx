// ClientServer wrapper for vtkParallelopipedRepresentation object
//
...
vtkObjectBase *vtkParallelopipedRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkParallelopipedRepresentation::New();
}


int VTK_EXPORT vtkParallelopipedRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkParallelopipedRepresentation *op = vtkParallelopipedRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkParallelopipedRepresentation.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkParallelopipedRepresentation  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("GetBoundingPlanes",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  if (!strcmp("SetHoveredHandleProperty",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkProperty  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkProperty"))
      {
  ...
  if (!strcmp("GetHoveredHandleProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
      temp20 = (op)->GetHoveredHandleProperty();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("GetHandleRepresentation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    vtkHandleRepresentation  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->GetHandleRepresentation(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("PositionHandles",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->PositionHandles();
      return 1;
  ...
  if (!strcmp("SetMinimumThickness",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetMinimumThickness",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
      temp20 = (op)->GetMinimumThickness();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkParallelopipedRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkParallelopipedRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkParallelopipedRepresentation", vtkParallelopipedRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkParallelopipedRepresentation", vtkParallelopipedRepresentationCommand);
    }
}
