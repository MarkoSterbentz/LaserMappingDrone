// ClientServer wrapper for vtkPlane object
//
...
vtkObjectBase *vtkPlaneClientServerNewCommand(void* /*ctx*/)
{
  return vtkPlane::New();
}


int VTK_EXPORT vtkPlaneCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPlane *op = vtkPlane::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPlane.  "
  ...
  if (!strcmp("DistanceToPlane",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[3];
    double   temp20;
    if(msg.GetArgument(0, 2, temp0, 3))
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPlane, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPlane_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPlane", vtkPlaneClientServerNewCommand);
    csi->AddCommandFunction("vtkPlane", vtkPlaneCommand);
    }
}
