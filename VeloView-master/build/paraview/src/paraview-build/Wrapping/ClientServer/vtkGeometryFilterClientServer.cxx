// ClientServer wrapper for vtkGeometryFilter object
//
...
vtkObjectBase *vtkGeometryFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkGeometryFilter::New();
}


int VTK_EXPORT vtkGeometryFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkGeometryFilter *op = vtkGeometryFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkGeometryFilter.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkGeometryFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkGeometryFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkGeometryFilter", vtkGeometryFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkGeometryFilter", vtkGeometryFilterCommand);
    }
}
