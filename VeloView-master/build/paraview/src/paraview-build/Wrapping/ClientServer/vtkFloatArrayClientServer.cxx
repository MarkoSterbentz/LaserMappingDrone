// ClientServer wrapper for vtkFloatArray object
//
...
vtkObjectBase *vtkFloatArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkFloatArray::New();
}


int VTK_EXPORT vtkFloatArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkFloatArray *op = vtkFloatArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkFloatArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkFloatArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkFloatArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkFloatArray", vtkFloatArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkFloatArray", vtkFloatArrayCommand);
    }
}
