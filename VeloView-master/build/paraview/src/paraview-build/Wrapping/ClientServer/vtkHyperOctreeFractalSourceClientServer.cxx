// ClientServer wrapper for vtkHyperOctreeFractalSource object
//
...
vtkObjectBase *vtkHyperOctreeFractalSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkHyperOctreeFractalSource::New();
}


int VTK_EXPORT vtkHyperOctreeFractalSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHyperOctreeFractalSource *op = vtkHyperOctreeFractalSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHyperOctreeFractalSource.  "
  ...
  if (!strcmp("NewInstance",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkHyperOctreeFractalSource  *temp20;
      {
  ...
  if (!strcmp("SetMinimumLevel",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetMinimumLevel",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetMinimumLevel();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("SetSizeCX",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[4];
    if(msg.GetArgument(0, 2, temp0, 4))
      {
  ...
  if (!strcmp("SetSpanThreshold",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetSpanThreshold",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
      temp20 = (op)->GetSpanThreshold();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  {
    const char* commandName = "vtkHyperOctreeAlgorithm";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHyperOctreeFractalSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHyperOctreeFractalSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkHyperOctreeFractalSource", vtkHyperOctreeFractalSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkHyperOctreeFractalSource", vtkHyperOctreeFractalSourceCommand);
    }
}
