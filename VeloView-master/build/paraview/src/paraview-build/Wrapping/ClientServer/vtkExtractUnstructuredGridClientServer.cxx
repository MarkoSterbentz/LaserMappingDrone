// ClientServer wrapper for vtkExtractUnstructuredGrid object
//
...
vtkObjectBase *vtkExtractUnstructuredGridClientServerNewCommand(void* /*ctx*/)
{
  return vtkExtractUnstructuredGrid::New();
}


int VTK_EXPORT vtkExtractUnstructuredGridCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkExtractUnstructuredGrid *op = vtkExtractUnstructuredGrid::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkExtractUnstructuredGrid.  "
  ...
  if (!strcmp("NewInstance",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkExtractUnstructuredGrid  *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkExtractUnstructuredGrid, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkExtractUnstructuredGrid_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkExtractUnstructuredGrid", vtkExtractUnstructuredGridClientServerNewCommand);
    csi->AddCommandFunction("vtkExtractUnstructuredGrid", vtkExtractUnstructuredGridCommand);
    }
}
