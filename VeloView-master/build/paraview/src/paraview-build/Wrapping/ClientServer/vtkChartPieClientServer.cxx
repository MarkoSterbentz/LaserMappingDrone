// ClientServer wrapper for vtkChartPie object
//
...
vtkObjectBase *vtkChartPieClientServerNewCommand(void* /*ctx*/)
{
  return vtkChartPie::New();
}


int VTK_EXPORT vtkChartPieCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkChartPie *op = vtkChartPie::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkChartPie.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkChartPie, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkChartPie_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkChartPie", vtkChartPieClientServerNewCommand);
    csi->AddCommandFunction("vtkChartPie", vtkChartPieCommand);
    }
}
