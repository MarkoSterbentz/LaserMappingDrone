// ClientServer wrapper for vtkHexagonalPrism object
//
...
vtkObjectBase *vtkHexagonalPrismClientServerNewCommand(void* /*ctx*/)
{
  return vtkHexagonalPrism::New();
}


int VTK_EXPORT vtkHexagonalPrismCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHexagonalPrism *op = vtkHexagonalPrism::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHexagonalPrism.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHexagonalPrism, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHexagonalPrism_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkHexagonalPrism", vtkHexagonalPrismClientServerNewCommand);
    csi->AddCommandFunction("vtkHexagonalPrism", vtkHexagonalPrismCommand);
    }
}
