// ClientServer wrapper for vtkHexahedron object
//
...
vtkObjectBase *vtkHexahedronClientServerNewCommand(void* /*ctx*/)
{
  return vtkHexahedron::New();
}


int VTK_EXPORT vtkHexahedronCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHexahedron *op = vtkHexahedron::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHexahedron.  "
  ...
  if (!strcmp("GetEdgeArray",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    int     *temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  if (!strcmp("GetFaceArray",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    int     *temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHexahedron, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHexahedron_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkHexahedron", vtkHexahedronClientServerNewCommand);
    csi->AddCommandFunction("vtkHexahedron", vtkHexahedronCommand);
    }
}
