// ClientServer wrapper for vtkInformationIntegerVectorKey object
//
...
int VTK_EXPORT vtkInformationIntegerVectorKeyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkInformationIntegerVectorKey *op = vtkInformationIntegerVectorKey::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkInformationIntegerVectorKey.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkInformationIntegerVectorKey, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkInformationIntegerVectorKey_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkInformationIntegerVectorKey", vtkInformationIntegerVectorKeyCommand);
    }
}
