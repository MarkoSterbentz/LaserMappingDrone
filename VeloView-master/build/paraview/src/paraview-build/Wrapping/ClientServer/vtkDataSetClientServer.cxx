// ClientServer wrapper for vtkDataSet object
//
...
int VTK_EXPORT vtkDataSetCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDataSet *op = vtkDataSet::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDataSet.  "
  ...
  if (!strcmp("CopyAttributes",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkDataSet  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkDataSet"))
      {
  ...
  if (!strcmp("GetScalarRange",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[2];
  ...
  if (!strcmp("CheckAttributes",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GenerateGhostLevelArray",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[6];
    if(msg.GetArgument(0, 2, temp0, 6))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDataSet, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDataSet_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkDataSet", vtkDataSetCommand);
    }
}
