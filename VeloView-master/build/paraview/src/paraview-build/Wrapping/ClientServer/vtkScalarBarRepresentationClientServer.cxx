// ClientServer wrapper for vtkScalarBarRepresentation object
//
...
vtkObjectBase *vtkScalarBarRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkScalarBarRepresentation::New();
}


int VTK_EXPORT vtkScalarBarRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkScalarBarRepresentation *op = vtkScalarBarRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkScalarBarRepresentation.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkScalarBarRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkScalarBarRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkScalarBarRepresentation", vtkScalarBarRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkScalarBarRepresentation", vtkScalarBarRepresentationCommand);
    }
}
