// ClientServer wrapper for vtkTriangle object
//
...
vtkObjectBase *vtkTriangleClientServerNewCommand(void* /*ctx*/)
{
  return vtkTriangle::New();
}


int VTK_EXPORT vtkTriangleCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkTriangle *op = vtkTriangle::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkTriangle.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkTriangle, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkTriangle_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkTriangle", vtkTriangleClientServerNewCommand);
    csi->AddCommandFunction("vtkTriangle", vtkTriangleCommand);
    }
}
