// ClientServer wrapper for vtkQuadraticPyramid object
//
...
vtkObjectBase *vtkQuadraticPyramidClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticPyramid::New();
}


int VTK_EXPORT vtkQuadraticPyramidCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticPyramid *op = vtkQuadraticPyramid::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticPyramid.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticPyramid, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticPyramid_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticPyramid", vtkQuadraticPyramidClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticPyramid", vtkQuadraticPyramidCommand);
    }
}
