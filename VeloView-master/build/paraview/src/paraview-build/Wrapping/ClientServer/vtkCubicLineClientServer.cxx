// ClientServer wrapper for vtkCubicLine object
//
...
vtkObjectBase *vtkCubicLineClientServerNewCommand(void* /*ctx*/)
{
  return vtkCubicLine::New();
}


int VTK_EXPORT vtkCubicLineCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCubicLine *op = vtkCubicLine::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCubicLine.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCubicLine, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCubicLine_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCubicLine", vtkCubicLineClientServerNewCommand);
    csi->AddCommandFunction("vtkCubicLine", vtkCubicLineCommand);
    }
}
