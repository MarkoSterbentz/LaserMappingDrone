// ClientServer wrapper for vtkResliceCursorLineRepresentation object
//
...
vtkObjectBase *vtkResliceCursorLineRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkResliceCursorLineRepresentation::New();
}


int VTK_EXPORT vtkResliceCursorLineRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkResliceCursorLineRepresentation *op = vtkResliceCursorLineRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkResliceCursorLineRepresentation.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkResliceCursorLineRepresentation  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("GetResliceCursorActor",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkResliceCursorActor  *temp20;
      {
      temp20 = (op)->GetResliceCursorActor();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  {
    const char* commandName = "vtkResliceCursorRepresentation";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkResliceCursorLineRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkResliceCursorLineRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkResliceCursorLineRepresentation", vtkResliceCursorLineRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkResliceCursorLineRepresentation", vtkResliceCursorLineRepresentationCommand);
    }
}
