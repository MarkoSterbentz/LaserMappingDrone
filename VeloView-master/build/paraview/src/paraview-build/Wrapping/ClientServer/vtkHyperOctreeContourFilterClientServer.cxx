// ClientServer wrapper for vtkHyperOctreeContourFilter object
//
...
vtkObjectBase *vtkHyperOctreeContourFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkHyperOctreeContourFilter::New();
}


int VTK_EXPORT vtkHyperOctreeContourFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHyperOctreeContourFilter *op = vtkHyperOctreeContourFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHyperOctreeContourFilter.  "
  ...
  if (!strcmp("NewInstance",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkHyperOctreeContourFilter  *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHyperOctreeContourFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHyperOctreeContourFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkHyperOctreeContourFilter", vtkHyperOctreeContourFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkHyperOctreeContourFilter", vtkHyperOctreeContourFilterCommand);
    }
}
