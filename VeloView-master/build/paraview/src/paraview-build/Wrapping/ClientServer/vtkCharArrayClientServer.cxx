// ClientServer wrapper for vtkCharArray object
//
...
vtkObjectBase *vtkCharArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkCharArray::New();
}


int VTK_EXPORT vtkCharArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCharArray *op = vtkCharArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCharArray.  "
  ...
  if (!strcmp("WritePointer",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkIdType   temp0;
    vtkIdType   temp1;
    char    *temp20;
  ...
  if (!strcmp("GetPointer",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkIdType   temp0;
    char    *temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCharArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCharArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCharArray", vtkCharArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkCharArray", vtkCharArrayCommand);
    }
}
