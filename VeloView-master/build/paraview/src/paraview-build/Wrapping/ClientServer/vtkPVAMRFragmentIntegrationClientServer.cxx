// ClientServer wrapper for vtkPVAMRFragmentIntegration object
//
...
vtkObjectBase *vtkPVAMRFragmentIntegrationClientServerNewCommand(void* /*ctx*/)
{
  return vtkPVAMRFragmentIntegration::New();
}


int VTK_EXPORT vtkPVAMRFragmentIntegrationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPVAMRFragmentIntegration *op = vtkPVAMRFragmentIntegration::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPVAMRFragmentIntegration.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPVAMRFragmentIntegration  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("SetContourConnection",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  {
    const char* commandName = "vtkAMRFragmentIntegration";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPVAMRFragmentIntegration, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPVAMRFragmentIntegration_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPVAMRFragmentIntegration", vtkPVAMRFragmentIntegrationClientServerNewCommand);
    csi->AddCommandFunction("vtkPVAMRFragmentIntegration", vtkPVAMRFragmentIntegrationCommand);
    }
}
