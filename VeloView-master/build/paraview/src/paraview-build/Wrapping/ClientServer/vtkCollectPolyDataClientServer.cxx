// ClientServer wrapper for vtkCollectPolyData object
//
...
vtkObjectBase *vtkCollectPolyDataClientServerNewCommand(void* /*ctx*/)
{
  return vtkCollectPolyData::New();
}


int VTK_EXPORT vtkCollectPolyDataCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCollectPolyData *op = vtkCollectPolyData::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCollectPolyData.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCollectPolyData, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCollectPolyData_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCollectPolyData", vtkCollectPolyDataClientServerNewCommand);
    csi->AddCommandFunction("vtkCollectPolyData", vtkCollectPolyDataCommand);
    }
}
