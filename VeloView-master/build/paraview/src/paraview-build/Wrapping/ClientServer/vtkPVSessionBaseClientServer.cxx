// ClientServer wrapper for vtkPVSessionBase object
//
...
int VTK_EXPORT vtkPVSessionBaseCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPVSessionBase *op = vtkPVSessionBase::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPVSessionBase.  "
  ...
  if (!strcmp("GetMPIMToNSocketConnection",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkMPIMToNSocketConnection  *temp20;
      {
      temp20 = (op)->GetMPIMToNSocketConnection();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("GetSessionCore",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPVSessionCore  *temp20;
      {
      temp20 = (op)->GetSessionCore();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("GetAllRemoteObjects",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkCollection  *temp0;
  ...
  if (!strcmp("IsProcessingRemoteNotification",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->IsProcessingRemoteNotification();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("UseSessionCoreOf",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  {
    const char* commandName = "vtkPVSession";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPVSessionBase, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPVSessionBase_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkPVSessionBase", vtkPVSessionBaseCommand);
    }
}
