// ClientServer wrapper for vtkDoubleArray object
//
...
vtkObjectBase *vtkDoubleArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkDoubleArray::New();
}


int VTK_EXPORT vtkDoubleArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDoubleArray *op = vtkDoubleArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDoubleArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDoubleArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDoubleArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDoubleArray", vtkDoubleArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkDoubleArray", vtkDoubleArrayCommand);
    }
}
