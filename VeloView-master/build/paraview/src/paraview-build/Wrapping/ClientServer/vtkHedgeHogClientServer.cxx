// ClientServer wrapper for vtkHedgeHog object
//
...
vtkObjectBase *vtkHedgeHogClientServerNewCommand(void* /*ctx*/)
{
  return vtkHedgeHog::New();
}


int VTK_EXPORT vtkHedgeHogCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHedgeHog *op = vtkHedgeHog::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHedgeHog.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHedgeHog, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHedgeHog_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkHedgeHog", vtkHedgeHogClientServerNewCommand);
    csi->AddCommandFunction("vtkHedgeHog", vtkHedgeHogCommand);
    }
}
