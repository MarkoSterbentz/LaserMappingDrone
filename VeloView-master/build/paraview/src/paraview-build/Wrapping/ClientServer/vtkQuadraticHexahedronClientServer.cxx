// ClientServer wrapper for vtkQuadraticHexahedron object
//
...
vtkObjectBase *vtkQuadraticHexahedronClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticHexahedron::New();
}


int VTK_EXPORT vtkQuadraticHexahedronCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticHexahedron *op = vtkQuadraticHexahedron::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticHexahedron.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticHexahedron, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticHexahedron_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticHexahedron", vtkQuadraticHexahedronClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticHexahedron", vtkQuadraticHexahedronCommand);
    }
}
