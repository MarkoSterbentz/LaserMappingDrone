// ClientServer wrapper for vtkLineSource object
//
...
vtkObjectBase *vtkLineSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkLineSource::New();
}


int VTK_EXPORT vtkLineSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLineSource *op = vtkLineSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLineSource.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLineSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLineSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLineSource", vtkLineSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkLineSource", vtkLineSourceCommand);
    }
}
