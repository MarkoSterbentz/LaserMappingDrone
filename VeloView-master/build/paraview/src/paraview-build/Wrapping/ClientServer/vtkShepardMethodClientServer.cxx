// ClientServer wrapper for vtkShepardMethod object
//
...
vtkObjectBase *vtkShepardMethodClientServerNewCommand(void* /*ctx*/)
{
  return vtkShepardMethod::New();
}


int VTK_EXPORT vtkShepardMethodCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkShepardMethod *op = vtkShepardMethod::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkShepardMethod.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkShepardMethod, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkShepardMethod_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkShepardMethod", vtkShepardMethodClientServerNewCommand);
    csi->AddCommandFunction("vtkShepardMethod", vtkShepardMethodCommand);
    }
}
