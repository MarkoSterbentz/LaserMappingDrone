// ClientServer wrapper for vtkPassInputTypeAlgorithm object
//
...
vtkObjectBase *vtkPassInputTypeAlgorithmClientServerNewCommand(void* /*ctx*/)
{
  return vtkPassInputTypeAlgorithm::New();
}


int VTK_EXPORT vtkPassInputTypeAlgorithmCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPassInputTypeAlgorithm *op = vtkPassInputTypeAlgorithm::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPassInputTypeAlgorithm.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPassInputTypeAlgorithm  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPassInputTypeAlgorithm, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPassInputTypeAlgorithm_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPassInputTypeAlgorithm", vtkPassInputTypeAlgorithmClientServerNewCommand);
    csi->AddCommandFunction("vtkPassInputTypeAlgorithm", vtkPassInputTypeAlgorithmCommand);
    }
}
