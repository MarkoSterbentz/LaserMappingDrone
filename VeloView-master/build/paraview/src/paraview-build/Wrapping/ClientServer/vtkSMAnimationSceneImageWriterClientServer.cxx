// ClientServer wrapper for vtkSMAnimationSceneImageWriter object
//
...
vtkObjectBase *vtkSMAnimationSceneImageWriterClientServerNewCommand(void* /*ctx*/)
{
  return vtkSMAnimationSceneImageWriter::New();
}


int VTK_EXPORT vtkSMAnimationSceneImageWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSMAnimationSceneImageWriter *op = vtkSMAnimationSceneImageWriter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSMAnimationSceneImageWriter.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSMAnimationSceneImageWriter  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("CompressionOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->CompressionOn();
      return 1;
  ...
  if (!strcmp("CompressionOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->CompressionOff();
      return 1;
  ...
  if (!strcmp("SetFrameRate",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetFrameRate",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  {
    const char* commandName = "vtkSMAnimationSceneWriter";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSMAnimationSceneImageWriter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSMAnimationSceneImageWriter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSMAnimationSceneImageWriter", vtkSMAnimationSceneImageWriterClientServerNewCommand);
    csi->AddCommandFunction("vtkSMAnimationSceneImageWriter", vtkSMAnimationSceneImageWriterCommand);
    }
}
