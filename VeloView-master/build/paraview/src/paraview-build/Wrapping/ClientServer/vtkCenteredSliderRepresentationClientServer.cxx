// ClientServer wrapper for vtkCenteredSliderRepresentation object
//
...
vtkObjectBase *vtkCenteredSliderRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkCenteredSliderRepresentation::New();
}


int VTK_EXPORT vtkCenteredSliderRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCenteredSliderRepresentation *op = vtkCenteredSliderRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCenteredSliderRepresentation.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkCenteredSliderRepresentation  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCenteredSliderRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCenteredSliderRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCenteredSliderRepresentation", vtkCenteredSliderRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkCenteredSliderRepresentation", vtkCenteredSliderRepresentationCommand);
    }
}
