// ClientServer wrapper for vtkArrayReader object
//
...
vtkObjectBase *vtkArrayReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkArrayReader::New();
}


int VTK_EXPORT vtkArrayReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkArrayReader *op = vtkArrayReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkArrayReader.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkArrayReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkArrayReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkArrayReader", vtkArrayReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkArrayReader", vtkArrayReaderCommand);
    }
}
