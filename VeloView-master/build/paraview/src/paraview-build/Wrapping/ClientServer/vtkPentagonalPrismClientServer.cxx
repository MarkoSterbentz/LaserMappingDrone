// ClientServer wrapper for vtkPentagonalPrism object
//
...
vtkObjectBase *vtkPentagonalPrismClientServerNewCommand(void* /*ctx*/)
{
  return vtkPentagonalPrism::New();
}


int VTK_EXPORT vtkPentagonalPrismCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPentagonalPrism *op = vtkPentagonalPrism::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPentagonalPrism.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPentagonalPrism, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPentagonalPrism_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPentagonalPrism", vtkPentagonalPrismClientServerNewCommand);
    csi->AddCommandFunction("vtkPentagonalPrism", vtkPentagonalPrismCommand);
    }
}
