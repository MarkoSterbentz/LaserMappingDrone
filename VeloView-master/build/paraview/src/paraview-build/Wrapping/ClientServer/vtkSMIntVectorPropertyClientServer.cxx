// ClientServer wrapper for vtkSMIntVectorProperty object
//
...
vtkObjectBase *vtkSMIntVectorPropertyClientServerNewCommand(void* /*ctx*/)
{
  return vtkSMIntVectorProperty::New();
}


int VTK_EXPORT vtkSMIntVectorPropertyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSMIntVectorProperty *op = vtkSMIntVectorProperty::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSMIntVectorProperty.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSMIntVectorProperty, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSMIntVectorProperty_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSMIntVectorProperty", vtkSMIntVectorPropertyClientServerNewCommand);
    csi->AddCommandFunction("vtkSMIntVectorProperty", vtkSMIntVectorPropertyCommand);
    }
}
