// ClientServer wrapper for vtkExtractArraysOverTime object
//
...
vtkObjectBase *vtkExtractArraysOverTimeClientServerNewCommand(void* /*ctx*/)
{
  return vtkExtractArraysOverTime::New();
}


int VTK_EXPORT vtkExtractArraysOverTimeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkExtractArraysOverTime *op = vtkExtractArraysOverTime::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkExtractArraysOverTime.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkExtractArraysOverTime  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkExtractArraysOverTime, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkExtractArraysOverTime_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkExtractArraysOverTime", vtkExtractArraysOverTimeClientServerNewCommand);
    csi->AddCommandFunction("vtkExtractArraysOverTime", vtkExtractArraysOverTimeCommand);
    }
}
