// ClientServer wrapper for vtkConnectivityFilter object
//
...
vtkObjectBase *vtkConnectivityFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkConnectivityFilter::New();
}


int VTK_EXPORT vtkConnectivityFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkConnectivityFilter *op = vtkConnectivityFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkConnectivityFilter.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkConnectivityFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkConnectivityFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkConnectivityFilter", vtkConnectivityFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkConnectivityFilter", vtkConnectivityFilterCommand);
    }
}
