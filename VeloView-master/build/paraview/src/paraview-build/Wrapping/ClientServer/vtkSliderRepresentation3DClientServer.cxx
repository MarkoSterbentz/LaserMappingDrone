// ClientServer wrapper for vtkSliderRepresentation3D object
//
...
vtkObjectBase *vtkSliderRepresentation3DClientServerNewCommand(void* /*ctx*/)
{
  return vtkSliderRepresentation3D::New();
}


int VTK_EXPORT vtkSliderRepresentation3DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSliderRepresentation3D *op = vtkSliderRepresentation3D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSliderRepresentation3D.  "
  ...
  if (!strcmp("SetPoint1InWorldCoordinates",method) && msg.GetNumberOfArguments(0) == 5)
    {
    double   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("SetPoint2InWorldCoordinates",method) && msg.GetNumberOfArguments(0) == 5)
    {
    double   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("SetSliderShape",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetSliderShapeMinValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetSliderShapeMaxValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("GetSliderShape",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("SetSliderShapeToSphere",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetSliderShapeToCylinder",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetRotation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetRotation",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetSliderProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("GetTubeProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("GetCapProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  {
    const char* commandName = "vtkSliderRepresentation";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSliderRepresentation3D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSliderRepresentation3D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSliderRepresentation3D", vtkSliderRepresentation3DClientServerNewCommand);
    csi->AddCommandFunction("vtkSliderRepresentation3D", vtkSliderRepresentation3DCommand);
    }
}
