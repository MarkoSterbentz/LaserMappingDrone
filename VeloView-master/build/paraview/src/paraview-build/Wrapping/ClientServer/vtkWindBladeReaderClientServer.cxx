// ClientServer wrapper for vtkWindBladeReader object
//
...
vtkObjectBase *vtkWindBladeReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkWindBladeReader::New();
}


int VTK_EXPORT vtkWindBladeReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkWindBladeReader *op = vtkWindBladeReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkWindBladeReader.  "
  ...
  if (!strcmp("SetSubExtent",method) && msg.GetNumberOfArguments(0) == 8)
    {
    int      temp0;
    int      temp1;
    int      temp2;
  ...
  if (!strcmp("SetSubExtent",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[6];
    if(msg.GetArgument(0, 2, temp0, 6))
      {
  ...
  if (!strcmp("GetSubExtent",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
  ...
  if (!strcmp("GetFieldOutput",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("GetBladeOutput",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("GetGroundOutput",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkStructuredGrid  *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkWindBladeReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkWindBladeReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkWindBladeReader", vtkWindBladeReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkWindBladeReader", vtkWindBladeReaderCommand);
    }
}
