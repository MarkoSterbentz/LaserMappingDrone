// ClientServer wrapper for vtkWedge object
//
...
vtkObjectBase *vtkWedgeClientServerNewCommand(void* /*ctx*/)
{
  return vtkWedge::New();
}


int VTK_EXPORT vtkWedgeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkWedge *op = vtkWedge::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkWedge.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkWedge, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkWedge_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkWedge", vtkWedgeClientServerNewCommand);
    csi->AddCommandFunction("vtkWedge", vtkWedgeCommand);
    }
}
