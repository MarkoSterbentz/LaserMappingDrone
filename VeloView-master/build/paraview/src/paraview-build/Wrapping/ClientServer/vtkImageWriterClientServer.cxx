// ClientServer wrapper for vtkImageWriter object
//
...
vtkObjectBase *vtkImageWriterClientServerNewCommand(void* /*ctx*/)
{
  return vtkImageWriter::New();
}


int VTK_EXPORT vtkImageWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkImageWriter *op = vtkImageWriter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkImageWriter.  "
  ...
  if (!strcmp("DeleteFiles",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->DeleteFiles();
      return 1;
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkImageWriter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkImageWriter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkImageWriter", vtkImageWriterClientServerNewCommand);
    csi->AddCommandFunction("vtkImageWriter", vtkImageWriterCommand);
    }
}
