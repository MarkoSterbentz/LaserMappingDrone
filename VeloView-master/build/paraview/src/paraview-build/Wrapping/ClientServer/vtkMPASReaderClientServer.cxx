// ClientServer wrapper for vtkMPASReader object
//
...
vtkObjectBase *vtkMPASReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkMPASReader::New();
}


int VTK_EXPORT vtkMPASReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkMPASReader *op = vtkMPASReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkMPASReader.  "
  ...
  if (!strcmp("SetCenterLon",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetCenterLonRange",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
  ...
  if (!strcmp("SetIsAtmosphere",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetIsAtmosphere",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  if (!strcmp("SetIsZeroCentered",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetIsZeroCentered",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkMPASReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkMPASReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkMPASReader", vtkMPASReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkMPASReader", vtkMPASReaderCommand);
    }
}
