// ClientServer wrapper for vtkQuadraticEdge object
//
...
vtkObjectBase *vtkQuadraticEdgeClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticEdge::New();
}


int VTK_EXPORT vtkQuadraticEdgeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticEdge *op = vtkQuadraticEdge::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticEdge.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticEdge, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticEdge_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticEdge", vtkQuadraticEdgeClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticEdge", vtkQuadraticEdgeCommand);
    }
}
