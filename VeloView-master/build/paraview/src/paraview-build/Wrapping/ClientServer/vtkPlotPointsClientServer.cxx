// ClientServer wrapper for vtkPlotPoints object
//
...
vtkObjectBase *vtkPlotPointsClientServerNewCommand(void* /*ctx*/)
{
  return vtkPlotPoints::New();
}


int VTK_EXPORT vtkPlotPointsCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPlotPoints *op = vtkPlotPoints::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPlotPoints.  "
  ...
  if (!strcmp("SelectColorArray",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->SelectColorArray(vtkStdString(temp0));
      return 1;
      }
    }
  ...
  if (!strcmp("GetMarkerStyle",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("SetMarkerStyle",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetMarkerSize",method) && msg.GetNumberOfArguments(0) == 2)
    {
    float    temp20;
      {
  ...
  if (!strcmp("SetMarkerSize",method) && msg.GetNumberOfArguments(0) == 3)
    {
    float    temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetValidPointMaskName",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkStdString   temp20;
      {
  ...
  if (!strcmp("SetValidPointMaskName",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *  temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
      op->SetValidPointMaskName(vtkStdString(temp0));
      return 1;
      }
    }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPlotPoints, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPlotPoints_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPlotPoints", vtkPlotPointsClientServerNewCommand);
    csi->AddCommandFunction("vtkPlotPoints", vtkPlotPointsCommand);
    }
}
