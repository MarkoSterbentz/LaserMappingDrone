// ClientServer wrapper for vtkBiQuadraticTriangle object
//
...
vtkObjectBase *vtkBiQuadraticTriangleClientServerNewCommand(void* /*ctx*/)
{
  return vtkBiQuadraticTriangle::New();
}


int VTK_EXPORT vtkBiQuadraticTriangleCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkBiQuadraticTriangle *op = vtkBiQuadraticTriangle::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkBiQuadraticTriangle.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkBiQuadraticTriangle, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkBiQuadraticTriangle_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkBiQuadraticTriangle", vtkBiQuadraticTriangleClientServerNewCommand);
    csi->AddCommandFunction("vtkBiQuadraticTriangle", vtkBiQuadraticTriangleCommand);
    }
}
