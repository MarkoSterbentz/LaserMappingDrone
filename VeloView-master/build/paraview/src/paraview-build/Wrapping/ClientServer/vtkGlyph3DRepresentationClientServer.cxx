// ClientServer wrapper for vtkGlyph3DRepresentation object
//
...
vtkObjectBase *vtkGlyph3DRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkGlyph3DRepresentation::New();
}


int VTK_EXPORT vtkGlyph3DRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkGlyph3DRepresentation *op = vtkGlyph3DRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkGlyph3DRepresentation.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkGlyph3DRepresentation  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("SetMeshVisibility",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkGlyph3DRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkGlyph3DRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkGlyph3DRepresentation", vtkGlyph3DRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkGlyph3DRepresentation", vtkGlyph3DRepresentationCommand);
    }
}
