// ClientServer wrapper for vtkDataObjectAlgorithm object
//
...
vtkObjectBase *vtkDataObjectAlgorithmClientServerNewCommand(void* /*ctx*/)
{
...
{
  vtkDataObjectAlgorithm *op = vtkDataObjectAlgorithm::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDataObjectAlgorithm.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDataObjectAlgorithm, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDataObjectAlgorithm_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDataObjectAlgorithm", vtkDataObjectAlgorithmClientServerNewCommand);
    csi->AddCommandFunction("vtkDataObjectAlgorithm", vtkDataObjectAlgorithmCommand);
    }
}
