// ClientServer wrapper for vtkTetra object
//
...
vtkObjectBase *vtkTetraClientServerNewCommand(void* /*ctx*/)
{
  return vtkTetra::New();
}


int VTK_EXPORT vtkTetraCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkTetra *op = vtkTetra::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkTetra.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkTetra, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkTetra_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkTetra", vtkTetraClientServerNewCommand);
    csi->AddCommandFunction("vtkTetra", vtkTetraCommand);
    }
}
