// ClientServer wrapper for vtkRenderViewBase object
//
...
vtkObjectBase *vtkRenderViewBaseClientServerNewCommand(void* /*ctx*/)
{
  return vtkRenderViewBase::New();
}


int VTK_EXPORT vtkRenderViewBaseCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkRenderViewBase *op = vtkRenderViewBase::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkRenderViewBase.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkRenderViewBase, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkRenderViewBase_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkRenderViewBase", vtkRenderViewBaseClientServerNewCommand);
    csi->AddCommandFunction("vtkRenderViewBase", vtkRenderViewBaseCommand);
    }
}
