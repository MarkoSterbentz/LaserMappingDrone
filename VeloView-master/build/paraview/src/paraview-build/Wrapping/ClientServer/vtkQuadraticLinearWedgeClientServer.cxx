// ClientServer wrapper for vtkQuadraticLinearWedge object
//
...
vtkObjectBase *vtkQuadraticLinearWedgeClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticLinearWedge::New();
}


int VTK_EXPORT vtkQuadraticLinearWedgeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticLinearWedge *op = vtkQuadraticLinearWedge::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticLinearWedge.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkQuadraticLinearWedge  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticLinearWedge, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticLinearWedge_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticLinearWedge", vtkQuadraticLinearWedgeClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticLinearWedge", vtkQuadraticLinearWedgeCommand);
    }
}
