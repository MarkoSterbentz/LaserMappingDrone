// ClientServer wrapper for vtkLongArray object
//
...
vtkObjectBase *vtkLongArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkLongArray::New();
}


int VTK_EXPORT vtkLongArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLongArray *op = vtkLongArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLongArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLongArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLongArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLongArray", vtkLongArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkLongArray", vtkLongArrayCommand);
    }
}
