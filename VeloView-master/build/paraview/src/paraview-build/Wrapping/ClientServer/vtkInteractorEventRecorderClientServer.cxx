// ClientServer wrapper for vtkInteractorEventRecorder object
//
...
vtkObjectBase *vtkInteractorEventRecorderClientServerNewCommand(void* /*ctx*/)
{
  return vtkInteractorEventRecorder::New();
}


int VTK_EXPORT vtkInteractorEventRecorderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkInteractorEventRecorder *op = vtkInteractorEventRecorder::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkInteractorEventRecorder.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkInteractorEventRecorder  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("Record",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->Record();
      return 1;
  ...
  if (!strcmp("Rewind",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->Rewind();
      return 1;
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkInteractorEventRecorder, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkInteractorEventRecorder_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkInteractorEventRecorder", vtkInteractorEventRecorderClientServerNewCommand);
    csi->AddCommandFunction("vtkInteractorEventRecorder", vtkInteractorEventRecorderCommand);
    }
}
