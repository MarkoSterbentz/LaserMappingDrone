// ClientServer wrapper for vtkCollectGraph object
//
...
vtkObjectBase *vtkCollectGraphClientServerNewCommand(void* /*ctx*/)
{
  return vtkCollectGraph::New();
}


int VTK_EXPORT vtkCollectGraphCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCollectGraph *op = vtkCollectGraph::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCollectGraph.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCollectGraph, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCollectGraph_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCollectGraph", vtkCollectGraphClientServerNewCommand);
    csi->AddCommandFunction("vtkCollectGraph", vtkCollectGraphCommand);
    }
}
