// ClientServer wrapper for vtkDICOMImageReader object
//
...
vtkObjectBase *vtkDICOMImageReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkDICOMImageReader::New();
}


int VTK_EXPORT vtkDICOMImageReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDICOMImageReader *op = vtkDICOMImageReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDICOMImageReader.  "
  ...
  if (!strcmp("SetDirectoryName",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetDirectoryName",method) && msg.GetNumberOfArguments(0) == 2)
    {
    char    *temp20;
      {
  ...
  if (!strcmp("GetPixelSpacing",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
  ...
  if (!strcmp("GetImagePositionPatient",method) && msg.GetNumberOfArguments(0) == 2)
    {
    float   *temp20;
      {
  ...
  if (!strcmp("GetImageOrientationPatient",method) && msg.GetNumberOfArguments(0) == 2)
    {
    float   *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDICOMImageReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDICOMImageReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDICOMImageReader", vtkDICOMImageReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkDICOMImageReader", vtkDICOMImageReaderCommand);
    }
}
