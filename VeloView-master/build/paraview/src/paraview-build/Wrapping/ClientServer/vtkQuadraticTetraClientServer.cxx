// ClientServer wrapper for vtkQuadraticTetra object
//
...
vtkObjectBase *vtkQuadraticTetraClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticTetra::New();
}


int VTK_EXPORT vtkQuadraticTetraCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticTetra *op = vtkQuadraticTetra::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticTetra.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticTetra, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticTetra_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticTetra", vtkQuadraticTetraClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticTetra", vtkQuadraticTetraCommand);
    }
}
