// ClientServer wrapper for vtkTransformToGrid object
//
...
vtkObjectBase *vtkTransformToGridClientServerNewCommand(void* /*ctx*/)
{
  return vtkTransformToGrid::New();
}


int VTK_EXPORT vtkTransformToGridCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkTransformToGrid *op = vtkTransformToGrid::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkTransformToGrid.  "
  ...
  if (!strcmp("GetGridExtent",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
  ...
  if (!strcmp("SetGridScalarType",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetGridScalarType",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("SetGridScalarTypeToDouble",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetGridScalarTypeToFloat",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetGridScalarTypeToShort",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetGridScalarTypeToUnsignedShort",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetGridScalarTypeToUnsignedChar",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetGridScalarTypeToChar",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("GetDisplacementShift",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkTransformToGrid, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkTransformToGrid_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkTransformToGrid", vtkTransformToGridClientServerNewCommand);
    csi->AddCommandFunction("vtkTransformToGrid", vtkTransformToGridCommand);
    }
}
