// ClientServer wrapper for vtkPlotBox object
//
...
vtkObjectBase *vtkPlotBoxClientServerNewCommand(void* /*ctx*/)
{
  return vtkPlotBox::New();
}


int VTK_EXPORT vtkPlotBoxCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPlotBox *op = vtkPlotBox::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPlotBox.  "
  ...
  if (!strcmp("SetColumnColor",method) && msg.GetNumberOfArguments(0) == 4)
    {
    char    *temp0;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      temp1)
      {
      op->SetColumnColor(vtkStdString(temp0),temp1);
      return 1;
      }
    }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPlotBox, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPlotBox_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPlotBox", vtkPlotBoxClientServerNewCommand);
    csi->AddCommandFunction("vtkPlotBox", vtkPlotBoxCommand);
    }
}
