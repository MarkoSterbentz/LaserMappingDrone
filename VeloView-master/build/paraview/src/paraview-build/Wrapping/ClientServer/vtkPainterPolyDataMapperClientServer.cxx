// ClientServer wrapper for vtkPainterPolyDataMapper object
//
...
vtkObjectBase *vtkPainterPolyDataMapperClientServerNewCommand(void* /*ctx*/)
{
  return vtkPainterPolyDataMapper::New();
}


int VTK_EXPORT vtkPainterPolyDataMapperCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPainterPolyDataMapper *op = vtkPainterPolyDataMapper::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPainterPolyDataMapper.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPainterPolyDataMapper  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("GetSelectionPainter",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPainter  *temp20;
      {
      temp20 = (op)->GetSelectionPainter();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("SetSelectionPainter",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkPainter  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkPainter"))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPainterPolyDataMapper, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPainterPolyDataMapper_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPainterPolyDataMapper", vtkPainterPolyDataMapperClientServerNewCommand);
    csi->AddCommandFunction("vtkPainterPolyDataMapper", vtkPainterPolyDataMapperCommand);
    }
}
