// ClientServer wrapper for vtkBiQuadraticQuadraticWedge object
//
...
vtkObjectBase *vtkBiQuadraticQuadraticWedgeClientServerNewCommand(void* /*ctx*/)
{
  return vtkBiQuadraticQuadraticWedge::New();
}


int VTK_EXPORT vtkBiQuadraticQuadraticWedgeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkBiQuadraticQuadraticWedge *op = vtkBiQuadraticQuadraticWedge::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkBiQuadraticQuadraticWedge.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkBiQuadraticQuadraticWedge  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkBiQuadraticQuadraticWedge, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkBiQuadraticQuadraticWedge_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkBiQuadraticQuadraticWedge", vtkBiQuadraticQuadraticWedgeClientServerNewCommand);
    csi->AddCommandFunction("vtkBiQuadraticQuadraticWedge", vtkBiQuadraticQuadraticWedgeCommand);
    }
}
