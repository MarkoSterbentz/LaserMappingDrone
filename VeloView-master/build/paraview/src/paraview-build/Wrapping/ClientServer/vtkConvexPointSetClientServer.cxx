// ClientServer wrapper for vtkConvexPointSet object
//
...
vtkObjectBase *vtkConvexPointSetClientServerNewCommand(void* /*ctx*/)
{
  return vtkConvexPointSet::New();
}


int VTK_EXPORT vtkConvexPointSetCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkConvexPointSet *op = vtkConvexPointSet::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkConvexPointSet.  "
  ...
  if (!strcmp("HasFixedTopology",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->HasFixedTopology();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  {
    const char* commandName = "vtkCell3D";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkConvexPointSet, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkConvexPointSet_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkConvexPointSet", vtkConvexPointSetClientServerNewCommand);
    csi->AddCommandFunction("vtkConvexPointSet", vtkConvexPointSetCommand);
    }
}
