// ClientServer wrapper for vtkFollower object
//
...
vtkObjectBase *vtkFollowerClientServerNewCommand(void* /*ctx*/)
{
  return vtkFollower::New();
}


int VTK_EXPORT vtkFollowerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkFollower *op = vtkFollower::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkFollower.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkFollower, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkFollower_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkFollower", vtkFollowerClientServerNewCommand);
    csi->AddCommandFunction("vtkFollower", vtkFollowerCommand);
    }
}
