// ClientServer wrapper for vtkPolyhedron object
//
...
vtkObjectBase *vtkPolyhedronClientServerNewCommand(void* /*ctx*/)
{
  return vtkPolyhedron::New();
}


int VTK_EXPORT vtkPolyhedronCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPolyhedron *op = vtkPolyhedron::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPolyhedron.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPolyhedron, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPolyhedron_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPolyhedron", vtkPolyhedronClientServerNewCommand);
    csi->AddCommandFunction("vtkPolyhedron", vtkPolyhedronCommand);
    }
}
