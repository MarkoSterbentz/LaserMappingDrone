// ClientServer wrapper for vtkPainterDeviceAdapter object
//
...
vtkObjectBase *vtkPainterDeviceAdapterClientServerNewCommand(void* /*ctx*/)
{
  return vtkPainterDeviceAdapter::New();
}


int VTK_EXPORT vtkPainterDeviceAdapterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPainterDeviceAdapter *op = vtkPainterDeviceAdapter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPainterDeviceAdapter.  "
  ...
  if (!strcmp("SetAttributePointer",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    vtkDataArray  *temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPainterDeviceAdapter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPainterDeviceAdapter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPainterDeviceAdapter", vtkPainterDeviceAdapterClientServerNewCommand);
    csi->AddCommandFunction("vtkPainterDeviceAdapter", vtkPainterDeviceAdapterCommand);
    }
}
