// ClientServer wrapper for vtkAxisFollower object
//
...
vtkObjectBase *vtkAxisFollowerClientServerNewCommand(void* /*ctx*/)
{
  return vtkAxisFollower::New();
}


int VTK_EXPORT vtkAxisFollowerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkAxisFollower *op = vtkAxisFollower::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkAxisFollower.  "
  ...
  if (!strcmp("ComputeTransformMatrix",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkRenderer  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkRenderer"))
      {
  ...
  {
    const char* commandName = "vtkFollower";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkAxisFollower, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkAxisFollower_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkAxisFollower", vtkAxisFollowerClientServerNewCommand);
    csi->AddCommandFunction("vtkAxisFollower", vtkAxisFollowerCommand);
    }
}
