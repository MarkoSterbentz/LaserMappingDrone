// ClientServer wrapper for vtkIdTypeArray object
//
...
vtkObjectBase *vtkIdTypeArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkIdTypeArray::New();
}


int VTK_EXPORT vtkIdTypeArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkIdTypeArray *op = vtkIdTypeArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkIdTypeArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkIdTypeArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkIdTypeArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkIdTypeArray", vtkIdTypeArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkIdTypeArray", vtkIdTypeArrayCommand);
    }
}
