// ClientServer wrapper for vtkDataObjectTree object
//
...
int VTK_EXPORT vtkDataObjectTreeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDataObjectTree *op = vtkDataObjectTree::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDataObjectTree.  "
  ...
  if (!strcmp("NewTreeIterator",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("SetDataSetFrom",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkDataObjectTreeIterator  *temp0;
    vtkDataObject  *temp1;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkDataObjectTreeIterator") &&
      vtkClientServerStreamGetArgumentObject(msg, 0, 3, &temp1, "vtkDataObject"))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDataObjectTree, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDataObjectTree_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkDataObjectTree", vtkDataObjectTreeCommand);
    }
}
