// ClientServer wrapper for vtkPolyVertex object
//
...
vtkObjectBase *vtkPolyVertexClientServerNewCommand(void* /*ctx*/)
{
  return vtkPolyVertex::New();
}


int VTK_EXPORT vtkPolyVertexCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPolyVertex *op = vtkPolyVertex::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPolyVertex.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPolyVertex, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPolyVertex_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPolyVertex", vtkPolyVertexClientServerNewCommand);
    csi->AddCommandFunction("vtkPolyVertex", vtkPolyVertexCommand);
    }
}
