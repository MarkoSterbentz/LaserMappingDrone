// ClientServer wrapper for vtkHyperOctreeSampleFunction object
//
...
vtkObjectBase *vtkHyperOctreeSampleFunctionClientServerNewCommand(void* /*ctx*/)
{
  return vtkHyperOctreeSampleFunction::New();
}


int VTK_EXPORT vtkHyperOctreeSampleFunctionCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHyperOctreeSampleFunction *op = vtkHyperOctreeSampleFunction::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHyperOctreeSampleFunction.  "
  ...
  if (!strcmp("NewInstance",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkHyperOctreeSampleFunction  *temp20;
      {
  ...
  if (!strcmp("GetLevels",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetLevels();
  ...
  if (!strcmp("SetLevels",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetMinLevels",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetMinLevels();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("SetMinLevels",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHyperOctreeSampleFunction, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHyperOctreeSampleFunction_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkHyperOctreeSampleFunction", vtkHyperOctreeSampleFunctionClientServerNewCommand);
    csi->AddCommandFunction("vtkHyperOctreeSampleFunction", vtkHyperOctreeSampleFunctionCommand);
    }
}
