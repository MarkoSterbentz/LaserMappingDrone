...
vtkObjectBase *vtkInteractorStyleMultiTouchCameraClientServerNewCommand(void* /*ctx*/)
{
  return vtkInteractorStyleMultiTouchCamera::New();
}


int VTK_EXPORT vtkInteractorStyleMultiTouchCameraCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  ...
  if (!strcmp("AdjustCamera",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->AdjustCamera();
      return 1;
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkInteractorStyleMultiTouchCamera_Init(vtkClientServerInterpreter* csi)
{
