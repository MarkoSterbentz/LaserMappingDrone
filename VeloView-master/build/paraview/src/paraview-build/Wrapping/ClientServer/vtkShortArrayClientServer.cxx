// ClientServer wrapper for vtkShortArray object
//
...
vtkObjectBase *vtkShortArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkShortArray::New();
}


int VTK_EXPORT vtkShortArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkShortArray *op = vtkShortArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkShortArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkShortArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkShortArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkShortArray", vtkShortArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkShortArray", vtkShortArrayCommand);
    }
}
