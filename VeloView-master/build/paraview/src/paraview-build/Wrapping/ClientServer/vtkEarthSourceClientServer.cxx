// ClientServer wrapper for vtkEarthSource object
//
...
vtkObjectBase *vtkEarthSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkEarthSource::New();
}


int VTK_EXPORT vtkEarthSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkEarthSource *op = vtkEarthSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkEarthSource.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkEarthSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkEarthSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkEarthSource", vtkEarthSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkEarthSource", vtkEarthSourceCommand);
    }
}
