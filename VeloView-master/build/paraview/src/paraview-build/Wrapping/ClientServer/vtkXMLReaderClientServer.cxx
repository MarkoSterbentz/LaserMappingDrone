// ClientServer wrapper for vtkXMLReader object
//
...
int VTK_EXPORT vtkXMLReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkXMLReader *op = vtkXMLReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkXMLReader.  "
  ...
  if (!strcmp("GetOutputAsDataSet",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkDataSet  *temp20;
      {
  ...
  if (!strcmp("GetOutputAsDataSet",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    vtkDataSet  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  if (!strcmp("GetXMLParser",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkXMLReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkXMLReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkXMLReader", vtkXMLReaderCommand);
    }
}
