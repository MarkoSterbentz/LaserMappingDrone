// ClientServer wrapper for vtkQuadraticQuad object
//
...
vtkObjectBase *vtkQuadraticQuadClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticQuad::New();
}


int VTK_EXPORT vtkQuadraticQuadCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticQuad *op = vtkQuadraticQuad::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticQuad.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticQuad, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticQuad_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticQuad", vtkQuadraticQuadClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticQuad", vtkQuadraticQuadCommand);
    }
}
