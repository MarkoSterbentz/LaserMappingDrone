// ClientServer wrapper for vtkArrayData object
//
...
vtkObjectBase *vtkArrayDataClientServerNewCommand(void* /*ctx*/)
{
  return vtkArrayData::New();
}


int VTK_EXPORT vtkArrayDataCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkArrayData *op = vtkArrayData::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkArrayData.  "
  ...
  if (!strcmp("AddArray",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkArray  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkArray"))
      {
      op->AddArray(temp0);
      return 1;
      }
  ...
  if (!strcmp("GetArrayByName",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    vtkArray  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkArrayData, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkArrayData_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkArrayData", vtkArrayDataClientServerNewCommand);
    csi->AddCommandFunction("vtkArrayData", vtkArrayDataCommand);
    }
}
