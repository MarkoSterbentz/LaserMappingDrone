// ClientServer wrapper for vtkSphereWidget2 object
//
...
vtkObjectBase *vtkSphereWidget2ClientServerNewCommand(void* /*ctx*/)
{
  return vtkSphereWidget2::New();
}


int VTK_EXPORT vtkSphereWidget2Command(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSphereWidget2 *op = vtkSphereWidget2::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSphereWidget2.  "
  ...
  if (!strcmp("SetRepresentation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkSphereRepresentation  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkSphereRepresentation"))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSphereWidget2, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSphereWidget2_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSphereWidget2", vtkSphereWidget2ClientServerNewCommand);
    csi->AddCommandFunction("vtkSphereWidget2", vtkSphereWidget2Command);
    }
}
