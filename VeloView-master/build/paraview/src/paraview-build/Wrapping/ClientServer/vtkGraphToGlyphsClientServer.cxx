// ClientServer wrapper for vtkGraphToGlyphs object
//
...
vtkObjectBase *vtkGraphToGlyphsClientServerNewCommand(void* /*ctx*/)
{
  return vtkGraphToGlyphs::New();
}


int VTK_EXPORT vtkGraphToGlyphsCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkGraphToGlyphs *op = vtkGraphToGlyphs::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkGraphToGlyphs.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkGraphToGlyphs, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkGraphToGlyphs_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkGraphToGlyphs", vtkGraphToGlyphsClientServerNewCommand);
    csi->AddCommandFunction("vtkGraphToGlyphs", vtkGraphToGlyphsCommand);
    }
}
