// ClientServer wrapper for vtkBoxRepresentation object
//
...
vtkObjectBase *vtkBoxRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkBoxRepresentation::New();
}


int VTK_EXPORT vtkBoxRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkBoxRepresentation *op = vtkBoxRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkBoxRepresentation.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkBoxRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkBoxRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkBoxRepresentation", vtkBoxRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkBoxRepresentation", vtkBoxRepresentationCommand);
    }
}
