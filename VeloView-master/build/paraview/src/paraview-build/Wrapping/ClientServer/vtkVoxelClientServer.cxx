// ClientServer wrapper for vtkVoxel object
//
...
vtkObjectBase *vtkVoxelClientServerNewCommand(void* /*ctx*/)
{
  return vtkVoxel::New();
}


int VTK_EXPORT vtkVoxelCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkVoxel *op = vtkVoxel::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkVoxel.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkVoxel, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkVoxel_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkVoxel", vtkVoxelClientServerNewCommand);
    csi->AddCommandFunction("vtkVoxel", vtkVoxelCommand);
    }
}
