// ClientServer wrapper for vtkImageAnisotropicDiffusion2D object
//
...
vtkObjectBase *vtkImageAnisotropicDiffusion2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkImageAnisotropicDiffusion2D::New();
}


int VTK_EXPORT vtkImageAnisotropicDiffusion2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkImageAnisotropicDiffusion2D *op = vtkImageAnisotropicDiffusion2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkImageAnisotropicDiffusion2D.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkImageAnisotropicDiffusion2D  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkImageAnisotropicDiffusion2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkImageAnisotropicDiffusion2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkImageAnisotropicDiffusion2D", vtkImageAnisotropicDiffusion2DClientServerNewCommand);
    csi->AddCommandFunction("vtkImageAnisotropicDiffusion2D", vtkImageAnisotropicDiffusion2DCommand);
    }
}
