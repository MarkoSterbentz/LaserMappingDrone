// ClientServer wrapper for vtkGeneralTransform object
//
...
vtkObjectBase *vtkGeneralTransformClientServerNewCommand(void* /*ctx*/)
{
  return vtkGeneralTransform::New();
}


int VTK_EXPORT vtkGeneralTransformCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkGeneralTransform *op = vtkGeneralTransform::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkGeneralTransform.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkGeneralTransform, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkGeneralTransform_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkGeneralTransform", vtkGeneralTransformClientServerNewCommand);
    csi->AddCommandFunction("vtkGeneralTransform", vtkGeneralTransformCommand);
    }
}
