// ClientServer wrapper for vtkStructuredGridAppend object
//
...
vtkObjectBase *vtkStructuredGridAppendClientServerNewCommand(void* /*ctx*/)
{
  return vtkStructuredGridAppend::New();
}


int VTK_EXPORT vtkStructuredGridAppendCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkStructuredGridAppend *op = vtkStructuredGridAppend::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkStructuredGridAppend.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkStructuredGridAppend  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkStructuredGridAppend, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkStructuredGridAppend_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkStructuredGridAppend", vtkStructuredGridAppendClientServerNewCommand);
    csi->AddCommandFunction("vtkStructuredGridAppend", vtkStructuredGridAppendCommand);
    }
}
