// ClientServer wrapper for vtkFileSeriesWriter object
//
...
vtkObjectBase *vtkFileSeriesWriterClientServerNewCommand(void* /*ctx*/)
{
  return vtkFileSeriesWriter::New();
}


int VTK_EXPORT vtkFileSeriesWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkFileSeriesWriter *op = vtkFileSeriesWriter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkFileSeriesWriter.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkFileSeriesWriter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkFileSeriesWriter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkFileSeriesWriter", vtkFileSeriesWriterClientServerNewCommand);
    csi->AddCommandFunction("vtkFileSeriesWriter", vtkFileSeriesWriterCommand);
    }
}
