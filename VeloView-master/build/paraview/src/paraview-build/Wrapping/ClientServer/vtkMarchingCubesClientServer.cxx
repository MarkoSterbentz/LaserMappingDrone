// ClientServer wrapper for vtkMarchingCubes object
//
...
vtkObjectBase *vtkMarchingCubesClientServerNewCommand(void* /*ctx*/)
{
  return vtkMarchingCubes::New();
}


int VTK_EXPORT vtkMarchingCubesCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkMarchingCubes *op = vtkMarchingCubes::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkMarchingCubes.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkMarchingCubes, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkMarchingCubes_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkMarchingCubes", vtkMarchingCubesClientServerNewCommand);
    csi->AddCommandFunction("vtkMarchingCubes", vtkMarchingCubesCommand);
    }
}
