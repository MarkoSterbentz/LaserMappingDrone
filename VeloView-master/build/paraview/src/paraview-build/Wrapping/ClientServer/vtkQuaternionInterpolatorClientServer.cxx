// ClientServer wrapper for vtkQuaternionInterpolator object
//
...
vtkObjectBase *vtkQuaternionInterpolatorClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuaternionInterpolator::New();
}


int VTK_EXPORT vtkQuaternionInterpolatorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuaternionInterpolator *op = vtkQuaternionInterpolator::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuaternionInterpolator.  "
  ...
  if (!strcmp("GetNumberOfQuaternions",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("RemoveQuaternion",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuaternionInterpolator, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuaternionInterpolator_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuaternionInterpolator", vtkQuaternionInterpolatorClientServerNewCommand);
    csi->AddCommandFunction("vtkQuaternionInterpolator", vtkQuaternionInterpolatorCommand);
    }
}
