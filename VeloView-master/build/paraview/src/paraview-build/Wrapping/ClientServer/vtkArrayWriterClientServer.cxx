// ClientServer wrapper for vtkArrayWriter object
//
...
vtkObjectBase *vtkArrayWriterClientServerNewCommand(void* /*ctx*/)
{
  return vtkArrayWriter::New();
}


int VTK_EXPORT vtkArrayWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkArrayWriter *op = vtkArrayWriter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkArrayWriter.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkArrayWriter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkArrayWriter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkArrayWriter", vtkArrayWriterClientServerNewCommand);
    csi->AddCommandFunction("vtkArrayWriter", vtkArrayWriterCommand);
    }
}
