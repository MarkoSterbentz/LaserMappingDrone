// ClientServer wrapper for vtkCameraRepresentation object
//
...
vtkObjectBase *vtkCameraRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkCameraRepresentation::New();
}


int VTK_EXPORT vtkCameraRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCameraRepresentation *op = vtkCameraRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCameraRepresentation.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkCameraRepresentation  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("SetInterpolator",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkCameraInterpolator  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkCameraInterpolator"))
      {
  ...
  if (!strcmp("GetNumberOfFramesMinValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetNumberOfFramesMinValue();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("GetNumberOfFramesMaxValue",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetNumberOfFramesMaxValue();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  if (!strcmp("AddCameraToPath",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->AddCameraToPath();
      return 1;
  ...
  if (!strcmp("AnimatePath",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  if (!strcmp("InitializePath",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->InitializePath();
      return 1;
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCameraRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCameraRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCameraRepresentation", vtkCameraRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkCameraRepresentation", vtkCameraRepresentationCommand);
    }
}
