...
vtkObjectBase *vtkDataSetToDataObjectFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkDataSetToDataObjectFilter::New();
}


int VTK_EXPORT vtkDataSetToDataObjectFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDataSetToDataObjectFilter_Init(vtkClientServerInterpreter* csi)
{
