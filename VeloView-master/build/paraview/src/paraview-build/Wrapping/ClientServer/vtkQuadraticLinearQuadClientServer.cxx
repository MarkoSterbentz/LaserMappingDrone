// ClientServer wrapper for vtkQuadraticLinearQuad object
//
...
vtkObjectBase *vtkQuadraticLinearQuadClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticLinearQuad::New();
}


int VTK_EXPORT vtkQuadraticLinearQuadCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticLinearQuad *op = vtkQuadraticLinearQuad::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticLinearQuad.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticLinearQuad, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticLinearQuad_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticLinearQuad", vtkQuadraticLinearQuadClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticLinearQuad", vtkQuadraticLinearQuadCommand);
    }
}
