// ClientServer wrapper for vtkUnsignedShortArray object
//
...
vtkObjectBase *vtkUnsignedShortArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkUnsignedShortArray::New();
}


int VTK_EXPORT vtkUnsignedShortArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkUnsignedShortArray *op = vtkUnsignedShortArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkUnsignedShortArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkUnsignedShortArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkUnsignedShortArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkUnsignedShortArray", vtkUnsignedShortArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkUnsignedShortArray", vtkUnsignedShortArrayCommand);
    }
}
