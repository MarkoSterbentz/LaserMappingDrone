// ClientServer wrapper for vtkPointSource object
//
...
vtkObjectBase *vtkPointSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkPointSource::New();
}


int VTK_EXPORT vtkPointSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPointSource *op = vtkPointSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPointSource.  "
  ...
  if (!strcmp("SetDistribution",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("SetDistributionToUniform",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetDistributionToShell",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("GetDistribution",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPointSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPointSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPointSource", vtkPointSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkPointSource", vtkPointSourceCommand);
    }
}
