// ClientServer wrapper for vtkRotationalExtrusionFilter object
//
...
vtkObjectBase *vtkRotationalExtrusionFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkRotationalExtrusionFilter::New();
}


int VTK_EXPORT vtkRotationalExtrusionFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkRotationalExtrusionFilter *op = vtkRotationalExtrusionFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkRotationalExtrusionFilter.  "
  ...
  if (!strcmp("NewInstance",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkRotationalExtrusionFilter  *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkRotationalExtrusionFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkRotationalExtrusionFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkRotationalExtrusionFilter", vtkRotationalExtrusionFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkRotationalExtrusionFilter", vtkRotationalExtrusionFilterCommand);
    }
}
