// ClientServer wrapper for vtkQuadraticPolygon object
//
...
vtkObjectBase *vtkQuadraticPolygonClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuadraticPolygon::New();
}


int VTK_EXPORT vtkQuadraticPolygonCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuadraticPolygon *op = vtkQuadraticPolygon::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuadraticPolygon.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuadraticPolygon, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuadraticPolygon_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuadraticPolygon", vtkQuadraticPolygonClientServerNewCommand);
    csi->AddCommandFunction("vtkQuadraticPolygon", vtkQuadraticPolygonCommand);
    }
}
