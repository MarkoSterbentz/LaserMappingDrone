// ClientServer wrapper for vtkAssembly object
//
...
vtkObjectBase *vtkAssemblyClientServerNewCommand(void* /*ctx*/)
{
  return vtkAssembly::New();
}


int VTK_EXPORT vtkAssemblyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkAssembly *op = vtkAssembly::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkAssembly.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkAssembly, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkAssembly_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkAssembly", vtkAssemblyClientServerNewCommand);
    csi->AddCommandFunction("vtkAssembly", vtkAssemblyCommand);
    }
}
