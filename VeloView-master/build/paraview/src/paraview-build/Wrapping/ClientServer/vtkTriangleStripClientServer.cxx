// ClientServer wrapper for vtkTriangleStrip object
//
...
vtkObjectBase *vtkTriangleStripClientServerNewCommand(void* /*ctx*/)
{
  return vtkTriangleStrip::New();
}


int VTK_EXPORT vtkTriangleStripCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkTriangleStrip *op = vtkTriangleStrip::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkTriangleStrip.  "
  ...
  if (!strcmp("DecomposeStrip",method) && msg.GetNumberOfArguments(0) == 5)
    {
    int      temp0;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      {
      op->DecomposeStrip(temp0,temp1,temp2);
      return 1;
      }
    }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkTriangleStrip, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkTriangleStrip_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkTriangleStrip", vtkTriangleStripClientServerNewCommand);
    csi->AddCommandFunction("vtkTriangleStrip", vtkTriangleStripCommand);
    }
}
