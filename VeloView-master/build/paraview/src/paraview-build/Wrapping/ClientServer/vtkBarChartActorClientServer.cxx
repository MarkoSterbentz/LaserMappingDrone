// ClientServer wrapper for vtkBarChartActor object
//
...
vtkObjectBase *vtkBarChartActorClientServerNewCommand(void* /*ctx*/)
{
  return vtkBarChartActor::New();
}


int VTK_EXPORT vtkBarChartActorCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkBarChartActor *op = vtkBarChartActor::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkBarChartActor.  "
  ...
  if (!strcmp("SetBarColor",method) && msg.GetNumberOfArguments(0) == 6)
    {
    int      temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("SetBarLabel",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    char    *temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("GetBarLabel",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    const char    *temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->GetBarLabel(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkBarChartActor, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkBarChartActor_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkBarChartActor", vtkBarChartActorClientServerNewCommand);
    csi->AddCommandFunction("vtkBarChartActor", vtkBarChartActorCommand);
    }
}
