// ClientServer wrapper for vtkQuerySelectionSource object
//
...
vtkObjectBase *vtkQuerySelectionSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuerySelectionSource::New();
}


int VTK_EXPORT vtkQuerySelectionSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuerySelectionSource *op = vtkQuerySelectionSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuerySelectionSource.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkQuerySelectionSource  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("GetUserFriendlyText",method) && msg.GetNumberOfArguments(0) == 2)
    {
    const char    *temp20;
      {
      temp20 = (op)->GetUserFriendlyText();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuerySelectionSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuerySelectionSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuerySelectionSource", vtkQuerySelectionSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkQuerySelectionSource", vtkQuerySelectionSourceCommand);
    }
}
