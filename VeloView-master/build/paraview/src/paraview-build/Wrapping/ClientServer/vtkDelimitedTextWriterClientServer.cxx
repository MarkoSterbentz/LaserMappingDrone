// ClientServer wrapper for vtkDelimitedTextWriter object
//
...
vtkObjectBase *vtkDelimitedTextWriterClientServerNewCommand(void* /*ctx*/)
{
  return vtkDelimitedTextWriter::New();
}


int VTK_EXPORT vtkDelimitedTextWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDelimitedTextWriter *op = vtkDelimitedTextWriter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDelimitedTextWriter.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDelimitedTextWriter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDelimitedTextWriter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDelimitedTextWriter", vtkDelimitedTextWriterClientServerNewCommand);
    csi->AddCommandFunction("vtkDelimitedTextWriter", vtkDelimitedTextWriterCommand);
    }
}
