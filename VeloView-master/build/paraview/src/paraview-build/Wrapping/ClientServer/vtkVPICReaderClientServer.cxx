// ClientServer wrapper for vtkVPICReader object
//
...
vtkObjectBase *vtkVPICReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkVPICReader::New();
}


int VTK_EXPORT vtkVPICReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkVPICReader *op = vtkVPICReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkVPICReader.  "
  ...
  if (!strcmp("SetXExtent",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    int      temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetXExtent",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[2];
  ...
  if (!strcmp("SetYExtent",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    int      temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetYExtent",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[2];
    if(msg.GetArgument(0, 2, temp0, 2))
      {
  ...
  if (!strcmp("SetZExtent",method) && msg.GetNumberOfArguments(0) == 4)
    {
    int      temp0;
    int      temp1;
    if(msg.GetArgument(0, 2, &temp0) &&
  ...
  if (!strcmp("SetZExtent",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int    temp0[2];
    if(msg.GetArgument(0, 2, temp0, 2))
      {
  ...
  if (!strcmp("GetXLayout",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
  ...
  if (!strcmp("GetYLayout",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
  ...
  if (!strcmp("GetZLayout",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int     *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkVPICReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkVPICReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkVPICReader", vtkVPICReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkVPICReader", vtkVPICReaderCommand);
    }
}
