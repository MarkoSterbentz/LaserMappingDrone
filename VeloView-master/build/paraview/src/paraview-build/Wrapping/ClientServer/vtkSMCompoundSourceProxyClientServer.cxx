// ClientServer wrapper for vtkSMCompoundSourceProxy object
//
...
vtkObjectBase *vtkSMCompoundSourceProxyClientServerNewCommand(void* /*ctx*/)
{
  return vtkSMCompoundSourceProxy::New();
}


int VTK_EXPORT vtkSMCompoundSourceProxyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSMCompoundSourceProxy *op = vtkSMCompoundSourceProxy::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSMCompoundSourceProxy.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSMCompoundSourceProxy  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSMCompoundSourceProxy, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSMCompoundSourceProxy_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSMCompoundSourceProxy", vtkSMCompoundSourceProxyClientServerNewCommand);
    csi->AddCommandFunction("vtkSMCompoundSourceProxy", vtkSMCompoundSourceProxyCommand);
    }
}
