// ClientServer wrapper for vtkBiDimensionalRepresentation2D object
//
...
vtkObjectBase *vtkBiDimensionalRepresentation2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkBiDimensionalRepresentation2D::New();
}


int VTK_EXPORT vtkBiDimensionalRepresentation2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkBiDimensionalRepresentation2D *op = vtkBiDimensionalRepresentation2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkBiDimensionalRepresentation2D.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkBiDimensionalRepresentation2D  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  {
    const char* commandName = "vtkBiDimensionalRepresentation";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkBiDimensionalRepresentation2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkBiDimensionalRepresentation2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkBiDimensionalRepresentation2D", vtkBiDimensionalRepresentation2DClientServerNewCommand);
    csi->AddCommandFunction("vtkBiDimensionalRepresentation2D", vtkBiDimensionalRepresentation2DCommand);
    }
}
