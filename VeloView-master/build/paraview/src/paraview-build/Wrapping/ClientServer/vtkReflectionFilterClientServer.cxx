// ClientServer wrapper for vtkReflectionFilter object
//
...
vtkObjectBase *vtkReflectionFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkReflectionFilter::New();
}


int VTK_EXPORT vtkReflectionFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkReflectionFilter *op = vtkReflectionFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkReflectionFilter.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkReflectionFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkReflectionFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkReflectionFilter", vtkReflectionFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkReflectionFilter", vtkReflectionFilterCommand);
    }
}
