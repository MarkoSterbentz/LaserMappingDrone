// ClientServer wrapper for vtkInformationDoubleVectorKey object
//
...
int VTK_EXPORT vtkInformationDoubleVectorKeyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkInformationDoubleVectorKey *op = vtkInformationDoubleVectorKey::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkInformationDoubleVectorKey.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkInformationDoubleVectorKey, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkInformationDoubleVectorKey_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkInformationDoubleVectorKey", vtkInformationDoubleVectorKeyCommand);
    }
}
