// ClientServer wrapper for vtkSTLWriter object
//
...
vtkObjectBase *vtkSTLWriterClientServerNewCommand(void* /*ctx*/)
{
  return vtkSTLWriter::New();
}


int VTK_EXPORT vtkSTLWriterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSTLWriter *op = vtkSTLWriter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSTLWriter.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSTLWriter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSTLWriter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSTLWriter", vtkSTLWriterClientServerNewCommand);
    csi->AddCommandFunction("vtkSTLWriter", vtkSTLWriterCommand);
    }
}
