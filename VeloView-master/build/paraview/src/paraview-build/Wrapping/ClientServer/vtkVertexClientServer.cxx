// ClientServer wrapper for vtkVertex object
//
...
vtkObjectBase *vtkVertexClientServerNewCommand(void* /*ctx*/)
{
  return vtkVertex::New();
}


int VTK_EXPORT vtkVertexCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkVertex *op = vtkVertex::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkVertex.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkVertex, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkVertex_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkVertex", vtkVertexClientServerNewCommand);
    csi->AddCommandFunction("vtkVertex", vtkVertexCommand);
    }
}
