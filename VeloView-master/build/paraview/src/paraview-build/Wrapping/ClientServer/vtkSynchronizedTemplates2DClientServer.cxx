// ClientServer wrapper for vtkSynchronizedTemplates2D object
//
...
vtkObjectBase *vtkSynchronizedTemplates2DClientServerNewCommand(void* /*ctx*/)
{
  return vtkSynchronizedTemplates2D::New();
}


int VTK_EXPORT vtkSynchronizedTemplates2DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSynchronizedTemplates2D *op = vtkSynchronizedTemplates2D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSynchronizedTemplates2D.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSynchronizedTemplates2D  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSynchronizedTemplates2D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSynchronizedTemplates2D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSynchronizedTemplates2D", vtkSynchronizedTemplates2DClientServerNewCommand);
    csi->AddCommandFunction("vtkSynchronizedTemplates2D", vtkSynchronizedTemplates2DCommand);
    }
}
