// ClientServer wrapper for vtkClipDataSet object
//
...
vtkObjectBase *vtkClipDataSetClientServerNewCommand(void* /*ctx*/)
{
  return vtkClipDataSet::New();
}


int VTK_EXPORT vtkClipDataSetCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkClipDataSet *op = vtkClipDataSet::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkClipDataSet.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkClipDataSet, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkClipDataSet_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkClipDataSet", vtkClipDataSetClientServerNewCommand);
    csi->AddCommandFunction("vtkClipDataSet", vtkClipDataSetCommand);
    }
}
