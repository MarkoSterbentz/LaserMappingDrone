// ClientServer wrapper for vtkImageSlice object
//
...
vtkObjectBase *vtkImageSliceClientServerNewCommand(void* /*ctx*/)
{
  return vtkImageSlice::New();
}


int VTK_EXPORT vtkImageSliceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkImageSlice *op = vtkImageSlice::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkImageSlice.  "
  ...
  if (!strcmp("SetMapper",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  if (!strcmp("GetMapper",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  if (!strcmp("GetMinXBound",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetMaxXBound",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetMinYBound",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetMaxYBound",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetMinZBound",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetMaxZBound",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
  ...
  if (!strcmp("GetImages",method) && msg.GetNumberOfArguments(0) == 3)
    {
  ...
  if (!strcmp("SetStackedImagePass",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkImageSlice, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkImageSlice_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkImageSlice", vtkImageSliceClientServerNewCommand);
    csi->AddCommandFunction("vtkImageSlice", vtkImageSliceCommand);
    }
}
