// ClientServer wrapper for vtkContourGrid object
//
...
vtkObjectBase *vtkContourGridClientServerNewCommand(void* /*ctx*/)
{
  return vtkContourGrid::New();
}


int VTK_EXPORT vtkContourGridCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkContourGrid *op = vtkContourGrid::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkContourGrid.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkContourGrid, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkContourGrid_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkContourGrid", vtkContourGridClientServerNewCommand);
    csi->AddCommandFunction("vtkContourGrid", vtkContourGridCommand);
    }
}
