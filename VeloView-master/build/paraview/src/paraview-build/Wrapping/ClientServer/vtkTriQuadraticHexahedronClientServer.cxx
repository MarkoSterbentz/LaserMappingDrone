// ClientServer wrapper for vtkTriQuadraticHexahedron object
//
...
vtkObjectBase *vtkTriQuadraticHexahedronClientServerNewCommand(void* /*ctx*/)
{
  return vtkTriQuadraticHexahedron::New();
}


int VTK_EXPORT vtkTriQuadraticHexahedronCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkTriQuadraticHexahedron *op = vtkTriQuadraticHexahedron::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkTriQuadraticHexahedron.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkTriQuadraticHexahedron  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkTriQuadraticHexahedron, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkTriQuadraticHexahedron_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkTriQuadraticHexahedron", vtkTriQuadraticHexahedronClientServerNewCommand);
    csi->AddCommandFunction("vtkTriQuadraticHexahedron", vtkTriQuadraticHexahedronCommand);
    }
}
