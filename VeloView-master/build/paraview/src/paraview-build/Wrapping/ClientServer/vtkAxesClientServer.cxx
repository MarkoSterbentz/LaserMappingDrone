// ClientServer wrapper for vtkAxes object
//
...
vtkObjectBase *vtkAxesClientServerNewCommand(void* /*ctx*/)
{
  return vtkAxes::New();
}


int VTK_EXPORT vtkAxesCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkAxes *op = vtkAxes::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkAxes.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkAxes, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkAxes_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkAxes", vtkAxesClientServerNewCommand);
    csi->AddCommandFunction("vtkAxes", vtkAxesCommand);
    }
}
