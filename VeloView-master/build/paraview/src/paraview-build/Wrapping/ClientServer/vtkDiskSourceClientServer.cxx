// ClientServer wrapper for vtkDiskSource object
//
...
vtkObjectBase *vtkDiskSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkDiskSource::New();
}


int VTK_EXPORT vtkDiskSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkDiskSource *op = vtkDiskSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkDiskSource.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkDiskSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkDiskSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkDiskSource", vtkDiskSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkDiskSource", vtkDiskSourceCommand);
    }
}
