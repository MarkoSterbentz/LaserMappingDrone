// ClientServer wrapper for vtkNetCDFPOPReader object
//
...
vtkObjectBase *vtkNetCDFPOPReaderClientServerNewCommand(void* /*ctx*/)
{
  return vtkNetCDFPOPReader::New();
}


int VTK_EXPORT vtkNetCDFPOPReaderCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkNetCDFPOPReader *op = vtkNetCDFPOPReader::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkNetCDFPOPReader.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkNetCDFPOPReader, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkNetCDFPOPReader_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkNetCDFPOPReader", vtkNetCDFPOPReaderClientServerNewCommand);
    csi->AddCommandFunction("vtkNetCDFPOPReader", vtkNetCDFPOPReaderCommand);
    }
}
