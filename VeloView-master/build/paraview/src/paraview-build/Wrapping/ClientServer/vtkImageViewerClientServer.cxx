// ClientServer wrapper for vtkImageViewer object
//
...
vtkObjectBase *vtkImageViewerClientServerNewCommand(void* /*ctx*/)
{
  return vtkImageViewer::New();
}


int VTK_EXPORT vtkImageViewerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkImageViewer *op = vtkImageViewer::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkImageViewer.  "
  ...
  if (!strcmp("GetImageMapper",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkImageViewer, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkImageViewer_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkImageViewer", vtkImageViewerClientServerNewCommand);
    csi->AddCommandFunction("vtkImageViewer", vtkImageViewerCommand);
    }
}
