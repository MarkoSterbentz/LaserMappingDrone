// ClientServer wrapper for vtkCollectTable object
//
...
vtkObjectBase *vtkCollectTableClientServerNewCommand(void* /*ctx*/)
{
  return vtkCollectTable::New();
}


int VTK_EXPORT vtkCollectTableCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkCollectTable *op = vtkCollectTable::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkCollectTable.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkCollectTable, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkCollectTable_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkCollectTable", vtkCollectTableClientServerNewCommand);
    csi->AddCommandFunction("vtkCollectTable", vtkCollectTableCommand);
    }
}
