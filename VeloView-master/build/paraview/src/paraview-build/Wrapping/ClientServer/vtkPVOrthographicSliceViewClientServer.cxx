// ClientServer wrapper for vtkPVOrthographicSliceView object
//
...
vtkObjectBase *vtkPVOrthographicSliceViewClientServerNewCommand(void* /*ctx*/)
{
  return vtkPVOrthographicSliceView::New();
}


int VTK_EXPORT vtkPVOrthographicSliceViewCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPVOrthographicSliceView *op = vtkPVOrthographicSliceView::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPVOrthographicSliceView.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPVOrthographicSliceView  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("SetSlicePosition",method) && msg.GetNumberOfArguments(0) == 5)
    {
    double   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("SetSliceIncrements",method) && msg.GetNumberOfArguments(0) == 5)
    {
    double   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("SetSliceIncrements",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[3];
  ...
  if (!strcmp("SetSliceAnnotationsVisibility",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetSliceAnnotationsVisibility",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->GetSliceAnnotationsVisibility();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  {
    const char* commandName = "vtkPVMultiSliceView";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPVOrthographicSliceView, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPVOrthographicSliceView_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPVOrthographicSliceView", vtkPVOrthographicSliceViewClientServerNewCommand);
    csi->AddCommandFunction("vtkPVOrthographicSliceView", vtkPVOrthographicSliceViewCommand);
    }
}
