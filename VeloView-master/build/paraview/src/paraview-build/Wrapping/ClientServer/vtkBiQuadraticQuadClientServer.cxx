// ClientServer wrapper for vtkBiQuadraticQuad object
//
...
vtkObjectBase *vtkBiQuadraticQuadClientServerNewCommand(void* /*ctx*/)
{
  return vtkBiQuadraticQuad::New();
}


int VTK_EXPORT vtkBiQuadraticQuadCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkBiQuadraticQuad *op = vtkBiQuadraticQuad::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkBiQuadraticQuad.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkBiQuadraticQuad, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkBiQuadraticQuad_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkBiQuadraticQuad", vtkBiQuadraticQuadClientServerNewCommand);
    csi->AddCommandFunction("vtkBiQuadraticQuad", vtkBiQuadraticQuadCommand);
    }
}
