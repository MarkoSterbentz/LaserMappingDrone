// ClientServer wrapper for vtkPVCompositeRepresentation object
//
...
vtkObjectBase *vtkPVCompositeRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkPVCompositeRepresentation::New();
}


int VTK_EXPORT vtkPVCompositeRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPVCompositeRepresentation *op = vtkPVCompositeRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPVCompositeRepresentation.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPVCompositeRepresentation  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("SetCubeAxesRepresentation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkCubeAxesRepresentation  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkCubeAxesRepresentation"))
      {
  ...
  if (!strcmp("SetSelectionRepresentation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkSelectionRepresentation  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkSelectionRepresentation"))
      {
  ...
  if (!strcmp("SetCubeAxesVisibility",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("SetSelectionVisibility",method) && msg.GetNumberOfArguments(0) == 3)
    {
    bool   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  {
    const char* commandName = "vtkCompositeRepresentation";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPVCompositeRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPVCompositeRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPVCompositeRepresentation", vtkPVCompositeRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkPVCompositeRepresentation", vtkPVCompositeRepresentationCommand);
    }
}
