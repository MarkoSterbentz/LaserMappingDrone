// ClientServer wrapper for vtkPointPlacer object
//
...
vtkObjectBase *vtkPointPlacerClientServerNewCommand(void* /*ctx*/)
{
  return vtkPointPlacer::New();
}


int VTK_EXPORT vtkPointPlacerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPointPlacer *op = vtkPointPlacer::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPointPlacer.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPointPlacer, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPointPlacer_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPointPlacer", vtkPointPlacerClientServerNewCommand);
    csi->AddCommandFunction("vtkPointPlacer", vtkPointPlacerCommand);
    }
}
