// ClientServer wrapper for vtkSMDoubleVectorProperty object
//
...
vtkObjectBase *vtkSMDoubleVectorPropertyClientServerNewCommand(void* /*ctx*/)
{
  return vtkSMDoubleVectorProperty::New();
}


int VTK_EXPORT vtkSMDoubleVectorPropertyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSMDoubleVectorProperty *op = vtkSMDoubleVectorProperty::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSMDoubleVectorProperty.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSMDoubleVectorProperty  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("SetElements4",method) && msg.GetNumberOfArguments(0) == 6)
    {
    double   temp0;
    double   temp1;
    double   temp2;
    ...
    if(msg.GetArgument(0, 2, &temp0) &&
      ...
      {
      temp20 = (op)->SetElements4(temp0,temp1,temp2,temp3);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSMDoubleVectorProperty, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSMDoubleVectorProperty_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSMDoubleVectorProperty", vtkSMDoubleVectorPropertyClientServerNewCommand);
    csi->AddCommandFunction("vtkSMDoubleVectorProperty", vtkSMDoubleVectorPropertyCommand);
    }
}
