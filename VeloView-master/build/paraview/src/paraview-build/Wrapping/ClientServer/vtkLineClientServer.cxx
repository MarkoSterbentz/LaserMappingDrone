// ClientServer wrapper for vtkLine object
//
...
vtkObjectBase *vtkLineClientServerNewCommand(void* /*ctx*/)
{
  return vtkLine::New();
}


int VTK_EXPORT vtkLineCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLine *op = vtkLine::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLine.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLine, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLine_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLine", vtkLineClientServerNewCommand);
    csi->AddCommandFunction("vtkLine", vtkLineCommand);
    }
}
