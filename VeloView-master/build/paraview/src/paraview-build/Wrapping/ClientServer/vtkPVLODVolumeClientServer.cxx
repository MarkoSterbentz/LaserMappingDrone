// ClientServer wrapper for vtkPVLODVolume object
//
...
vtkObjectBase *vtkPVLODVolumeClientServerNewCommand(void* /*ctx*/)
{
  return vtkPVLODVolume::New();
}


int VTK_EXPORT vtkPVLODVolumeCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPVLODVolume *op = vtkPVLODVolume::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPVLODVolume.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPVLODVolume, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPVLODVolume_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPVLODVolume", vtkPVLODVolumeClientServerNewCommand);
    csi->AddCommandFunction("vtkPVLODVolume", vtkPVLODVolumeCommand);
    }
}
