// ClientServer wrapper for vtkAMRDualClip object
//
...
vtkObjectBase *vtkAMRDualClipClientServerNewCommand(void* /*ctx*/)
{
  return vtkAMRDualClip::New();
}


int VTK_EXPORT vtkAMRDualClipCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkAMRDualClip *op = vtkAMRDualClip::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkAMRDualClip.  "
  ...
  if (!strcmp("SetEnableInternalDecimation",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetEnableInternalDecimation",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetEnableInternalDecimation();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkAMRDualClip, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkAMRDualClip_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkAMRDualClip", vtkAMRDualClipClientServerNewCommand);
    csi->AddCommandFunction("vtkAMRDualClip", vtkAMRDualClipCommand);
    }
}
