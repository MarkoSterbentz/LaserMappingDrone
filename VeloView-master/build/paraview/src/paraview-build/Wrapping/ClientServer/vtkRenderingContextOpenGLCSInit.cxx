...
extern "C" void VTK_WRAP_CS_EXPORT vtkRenderingContextOpenGLCS_Initialize(
  vtkClientServerInterpreter *csi)
{
  ...
  if (!initialized)
    {
    initialized = true;
    PyImport_AppendInittab("vtkRenderingContextOpenGLPython", initvtkRenderingContextOpenGLPython);
    }

  csi->Load("vtkRenderingContextOpenGL");
#endif
