// ClientServer wrapper for vtkLineRepresentation object
//
...
vtkObjectBase *vtkLineRepresentationClientServerNewCommand(void* /*ctx*/)
{
  return vtkLineRepresentation::New();
}


int VTK_EXPORT vtkLineRepresentationCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkLineRepresentation *op = vtkLineRepresentation::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkLineRepresentation.  "
  ...
  if (!strcmp("GetPoint1DisplayPosition",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
  ...
  if (!strcmp("GetPoint2DisplayPosition",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double  *temp20;
      {
  ...
  if (!strcmp("SetHandleRepresentation",method) && msg.GetNumberOfArguments(0) == 3)
    ...
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkPointHandleRepresentation3D"))
      {
  ...
  if (!strcmp("GetLineHandleRepresentation",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkPointHandleRepresentation3D  *temp20;
      {
  ...
  if (!strcmp("GetEndPointProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("GetSelectedEndPointProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("GetEndPoint2Property",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("GetSelectedEndPoint2Property",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  if (!strcmp("SetDistanceAnnotationVisibility",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetDistanceAnnotationVisibility",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
  ...
  if (!strcmp("DistanceAnnotationVisibilityOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("DistanceAnnotationVisibilityOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
  ...
  if (!strcmp("SetDistanceAnnotationFormat",method) && msg.GetNumberOfArguments(0) == 3)
    {
    char    *temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetDistanceAnnotationFormat",method) && msg.GetNumberOfArguments(0) == 2)
    {
    char    *temp20;
      {
  ...
  if (!strcmp("SetDistanceAnnotationScale",method) && msg.GetNumberOfArguments(0) == 5)
    {
    double   temp0;
    double   temp1;
    double   temp2;
  ...
  if (!strcmp("SetDistanceAnnotationScale",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double temp0[3];
    if(msg.GetArgument(0, 2, temp0, 3))
      {
  ...
  if (!strcmp("GetDistanceAnnotationProperty",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkProperty  *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkLineRepresentation, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkLineRepresentation_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkLineRepresentation", vtkLineRepresentationClientServerNewCommand);
    csi->AddCommandFunction("vtkLineRepresentation", vtkLineRepresentationCommand);
    }
}
