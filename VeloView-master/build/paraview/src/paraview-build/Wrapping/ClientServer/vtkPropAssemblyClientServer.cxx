// ClientServer wrapper for vtkPropAssembly object
//
...
vtkObjectBase *vtkPropAssemblyClientServerNewCommand(void* /*ctx*/)
{
  return vtkPropAssembly::New();
}


int VTK_EXPORT vtkPropAssemblyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPropAssembly *op = vtkPropAssembly::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPropAssembly.  "
  ...
  if (!strcmp("AddPart",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkProp  *temp0;
  ...
  if (!strcmp("RemovePart",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkProp  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkProp"))
      {
  ...
  if (!strcmp("GetParts",method) && msg.GetNumberOfArguments(0) == 2)
    {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPropAssembly, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPropAssembly_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPropAssembly", vtkPropAssemblyClientServerNewCommand);
    csi->AddCommandFunction("vtkPropAssembly", vtkPropAssemblyCommand);
    }
}
