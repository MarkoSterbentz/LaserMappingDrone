// ClientServer wrapper for vtkEmptyCell object
//
...
vtkObjectBase *vtkEmptyCellClientServerNewCommand(void* /*ctx*/)
{
  return vtkEmptyCell::New();
}


int VTK_EXPORT vtkEmptyCellCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkEmptyCell *op = vtkEmptyCell::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkEmptyCell.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkEmptyCell, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkEmptyCell_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkEmptyCell", vtkEmptyCellClientServerNewCommand);
    csi->AddCommandFunction("vtkEmptyCell", vtkEmptyCellCommand);
    }
}
