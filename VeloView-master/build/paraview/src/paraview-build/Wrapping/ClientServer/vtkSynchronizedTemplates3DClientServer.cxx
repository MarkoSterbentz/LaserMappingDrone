// ClientServer wrapper for vtkSynchronizedTemplates3D object
//
...
vtkObjectBase *vtkSynchronizedTemplates3DClientServerNewCommand(void* /*ctx*/)
{
  return vtkSynchronizedTemplates3D::New();
}


int VTK_EXPORT vtkSynchronizedTemplates3DCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkSynchronizedTemplates3D *op = vtkSynchronizedTemplates3D::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkSynchronizedTemplates3D.  "
  ...
  if (!strcmp("New",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkSynchronizedTemplates3D  *temp20;
      {
      temp20 = (op)->New();
      resultStream.Reset();
  ...
  if (!strcmp("ThreadedExecute",method) && msg.GetNumberOfArguments(0) == 6)
    {
    vtkImageData  *temp0;
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkSynchronizedTemplates3D, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkSynchronizedTemplates3D_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkSynchronizedTemplates3D", vtkSynchronizedTemplates3DClientServerNewCommand);
    csi->AddCommandFunction("vtkSynchronizedTemplates3D", vtkSynchronizedTemplates3DCommand);
    }
}
