// ClientServer wrapper for vtkQuad object
//
...
vtkObjectBase *vtkQuadClientServerNewCommand(void* /*ctx*/)
{
  return vtkQuad::New();
}


int VTK_EXPORT vtkQuadCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkQuad *op = vtkQuad::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkQuad.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkQuad, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkQuad_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkQuad", vtkQuadClientServerNewCommand);
    csi->AddCommandFunction("vtkQuad", vtkQuadCommand);
    }
}
