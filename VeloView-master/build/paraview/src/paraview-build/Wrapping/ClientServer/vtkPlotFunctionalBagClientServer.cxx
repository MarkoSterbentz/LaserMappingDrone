// ClientServer wrapper for vtkPlotFunctionalBag object
//
...
vtkObjectBase *vtkPlotFunctionalBagClientServerNewCommand(void* /*ctx*/)
{
  return vtkPlotFunctionalBag::New();
}


int VTK_EXPORT vtkPlotFunctionalBagCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPlotFunctionalBag *op = vtkPlotFunctionalBag::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPlotFunctionalBag.  "
  ...
  if (!strcmp("IsBag",method) && msg.GetNumberOfArguments(0) == 2)
    {
    bool   temp20;
      {
      temp20 = (op)->IsBag();
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPlotFunctionalBag, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPlotFunctionalBag_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPlotFunctionalBag", vtkPlotFunctionalBagClientServerNewCommand);
    csi->AddCommandFunction("vtkPlotFunctionalBag", vtkPlotFunctionalBagCommand);
    }
}
