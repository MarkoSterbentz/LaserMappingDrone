// ClientServer wrapper for vtkHyperOctreeAlgorithm object
//
...
int VTK_EXPORT vtkHyperOctreeAlgorithmCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkHyperOctreeAlgorithm *op = vtkHyperOctreeAlgorithm::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkHyperOctreeAlgorithm.  "
  ...
  if (!strcmp("NewInstance",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkHyperOctreeAlgorithm  *temp20;
      {
  ...
  if (!strcmp("GetHyperOctreeInput",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    vtkHyperOctree  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->GetHyperOctreeInput(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkHyperOctreeAlgorithm, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkHyperOctreeAlgorithm_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkHyperOctreeAlgorithm", vtkHyperOctreeAlgorithmCommand);
    }
}
