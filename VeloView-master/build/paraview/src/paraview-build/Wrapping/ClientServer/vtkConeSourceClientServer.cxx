// ClientServer wrapper for vtkConeSource object
//
...
vtkObjectBase *vtkConeSourceClientServerNewCommand(void* /*ctx*/)
{
  return vtkConeSource::New();
}


int VTK_EXPORT vtkConeSourceCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkConeSource *op = vtkConeSource::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkConeSource.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkConeSource, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkConeSource_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkConeSource", vtkConeSourceClientServerNewCommand);
    csi->AddCommandFunction("vtkConeSource", vtkConeSourceCommand);
    }
}
