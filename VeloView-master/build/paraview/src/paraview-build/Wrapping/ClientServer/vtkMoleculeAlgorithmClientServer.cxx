// ClientServer wrapper for vtkMoleculeAlgorithm object
//
...
vtkObjectBase *vtkMoleculeAlgorithmClientServerNewCommand(void* /*ctx*/)
{
  return vtkMoleculeAlgorithm::New();
}


int VTK_EXPORT vtkMoleculeAlgorithmCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkMoleculeAlgorithm *op = vtkMoleculeAlgorithm::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkMoleculeAlgorithm.  "
  ...
  if (!strcmp("GetMoleculeInput",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    vtkMolecule  *temp20;
    if(msg.GetArgument(0, 2, &temp0))
      {
      temp20 = (op)->GetMoleculeInput(temp0);
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << (vtkObjectBase *)temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkMoleculeAlgorithm, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkMoleculeAlgorithm_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkMoleculeAlgorithm", vtkMoleculeAlgorithmClientServerNewCommand);
    csi->AddCommandFunction("vtkMoleculeAlgorithm", vtkMoleculeAlgorithmCommand);
    }
}
