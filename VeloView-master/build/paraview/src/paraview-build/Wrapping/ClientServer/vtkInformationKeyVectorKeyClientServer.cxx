// ClientServer wrapper for vtkInformationKeyVectorKey object
//
...
int VTK_EXPORT vtkInformationKeyVectorKeyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkInformationKeyVectorKey *op = vtkInformationKeyVectorKey::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkInformationKeyVectorKey.  "
  ...
  if (!strcmp("RemoveItem",method) && msg.GetNumberOfArguments(0) == 4)
    {
    vtkInformation  *temp0;
    vtkInformationKey  *temp1;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkInformation") &&
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkInformationKeyVectorKey, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkInformationKeyVectorKey_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkInformationKeyVectorKey", vtkInformationKeyVectorKeyCommand);
    }
}
