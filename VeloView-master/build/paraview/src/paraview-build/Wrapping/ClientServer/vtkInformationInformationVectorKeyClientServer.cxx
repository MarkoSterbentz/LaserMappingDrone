// ClientServer wrapper for vtkInformationInformationVectorKey object
//
...
int VTK_EXPORT vtkInformationInformationVectorKeyCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkInformationInformationVectorKey *op = vtkInformationInformationVectorKey::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkInformationInformationVectorKey.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkInformationInformationVectorKey, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkInformationInformationVectorKey_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddCommandFunction("vtkInformationInformationVectorKey", vtkInformationInformationVectorKeyCommand);
    }
}
