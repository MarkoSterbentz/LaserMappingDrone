// ClientServer wrapper for vtkMarchingContourFilter object
//
...
vtkObjectBase *vtkMarchingContourFilterClientServerNewCommand(void* /*ctx*/)
{
  return vtkMarchingContourFilter::New();
}


int VTK_EXPORT vtkMarchingContourFilterCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkMarchingContourFilter *op = vtkMarchingContourFilter::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkMarchingContourFilter.  "
  ...
  if (!strcmp("NewInstance",method) && msg.GetNumberOfArguments(0) == 2)
    {
    vtkMarchingContourFilter  *temp20;
      {
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkMarchingContourFilter, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkMarchingContourFilter_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkMarchingContourFilter", vtkMarchingContourFilterClientServerNewCommand);
    csi->AddCommandFunction("vtkMarchingContourFilter", vtkMarchingContourFilterCommand);
    }
}
