// ClientServer wrapper for vtkUnsignedIntArray object
//
...
vtkObjectBase *vtkUnsignedIntArrayClientServerNewCommand(void* /*ctx*/)
{
  return vtkUnsignedIntArray::New();
}


int VTK_EXPORT vtkUnsignedIntArrayCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkUnsignedIntArray *op = vtkUnsignedIntArray::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkUnsignedIntArray.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkUnsignedIntArray, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkUnsignedIntArray_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkUnsignedIntArray", vtkUnsignedIntArrayClientServerNewCommand);
    csi->AddCommandFunction("vtkUnsignedIntArray", vtkUnsignedIntArrayCommand);
    }
}
