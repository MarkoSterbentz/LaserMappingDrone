// ClientServer wrapper for vtkPen object
//
...
vtkObjectBase *vtkPenClientServerNewCommand(void* /*ctx*/)
{
  return vtkPen::New();
}


int VTK_EXPORT vtkPenCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkPen *op = vtkPen::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkPen.  "
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkPen, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkPen_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkPen", vtkPenClientServerNewCommand);
    csi->AddCommandFunction("vtkPen", vtkPenCommand);
    }
}
