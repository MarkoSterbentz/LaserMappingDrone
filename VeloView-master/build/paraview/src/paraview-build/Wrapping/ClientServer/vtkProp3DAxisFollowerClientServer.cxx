// ClientServer wrapper for vtkProp3DAxisFollower object
//
...
vtkObjectBase *vtkProp3DAxisFollowerClientServerNewCommand(void* /*ctx*/)
{
  return vtkProp3DAxisFollower::New();
}


int VTK_EXPORT vtkProp3DAxisFollowerCommand(vtkClientServerInterpreter *arlu, vtkObjectBase *ob, const char *method, const vtkClientServerStream& msg, vtkClientServerStream& resultStream, void* /*ctx*/)
{
  vtkProp3DAxisFollower *op = vtkProp3DAxisFollower::SafeDownCast(ob);
  if(!op)
    {
    vtkOStrStreamWrapper vtkmsg;
    vtkmsg << "Cannot cast " << ob->GetClassName() << " object to vtkProp3DAxisFollower.  "
  ...
  if (!strcmp("SetAxis",method) && msg.GetNumberOfArguments(0) == 3)
    {
    vtkAxisActor  *temp0;
    if(vtkClientServerStreamGetArgumentObject(msg, 0, 2, &temp0, "vtkAxisActor"))
      {
      op->SetAxis(temp0);
      return 1;
      }
  ...
  if (!strcmp("SetAutoCenter",method) && msg.GetNumberOfArguments(0) == 3)
    {
    int      temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetAutoCenter",method) && msg.GetNumberOfArguments(0) == 2)
    {
    int      temp20;
      {
      temp20 = (op)->GetAutoCenter();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
    }
  if (!strcmp("AutoCenterOn",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->AutoCenterOn();
      return 1;
  ...
  if (!strcmp("AutoCenterOff",method) && msg.GetNumberOfArguments(0) == 2)
    {
      {
      op->AutoCenterOff();
      return 1;
  ...
  if (!strcmp("SetScreenOffset",method) && msg.GetNumberOfArguments(0) == 3)
    {
    double   temp0;
    if(msg.GetArgument(0, 2, &temp0))
      {
  ...
  if (!strcmp("GetScreenOffset",method) && msg.GetNumberOfArguments(0) == 2)
    {
    double   temp20;
      {
      temp20 = (op)->GetScreenOffset();
      resultStream.Reset();
      resultStream << vtkClientServerStream::Reply << temp20 << vtkClientServerStream::End;
      return 1;
      }
  ...
  {
    const char* commandName = "vtkProp3DFollower";
  ...
  vtkOStrStreamWrapper vtkmsg;
  vtkmsg << "Object type: vtkProp3DAxisFollower, could not find requested method: \""
...
//-------------------------------------------------------------------------auto
void VTK_EXPORT vtkProp3DAxisFollower_Init(vtkClientServerInterpreter* csi)
{
  static vtkClientServerInterpreter* last = NULL;
  if(last != csi)
    {
    last = csi;
    csi->AddNewInstanceFunction("vtkProp3DAxisFollower", vtkProp3DAxisFollowerClientServerNewCommand);
    csi->AddCommandFunction("vtkProp3DAxisFollower", vtkProp3DAxisFollowerCommand);
    }
}
