...
#include "../../../paraview/Qt/Widgets/pqCollapsedGroup.h"
...
static const char qt_meta_stringdata_pqCollapsedGroup[] = {
    "pqCollapsedGroup\0bool\0collapsed\0"
};
...
const QMetaObjectExtraData pqCollapsedGroup::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqCollapsedGroup::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_pqCollapsedGroup,
      qt_meta_data_pqCollapsedGroup, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqCollapsedGroup::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqCollapsedGroup))
        return static_cast<void*>(const_cast< pqCollapsedGroup*>(this));
