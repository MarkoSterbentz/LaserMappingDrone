...
#include "../../../paraview/Qt/Widgets/pqTreeView.h"
...
static const char qt_meta_stringdata_pqTreeView[] = {
    "pqTreeView\0\0invalidateLayout()\0int\0"
...
const QMetaObjectExtraData pqTreeView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqTreeView::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_pqTreeView,
      qt_meta_data_pqTreeView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqTreeView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqTreeView))
        return static_cast<void*>(const_cast< pqTreeView*>(this));
