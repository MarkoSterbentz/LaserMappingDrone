...
#include "../../../paraview/Qt/Widgets/pqColorButtonEventPlayer.h"
...
static const char qt_meta_stringdata_pqColorButtonEventPlayer[] = {
    "pqColorButtonEventPlayer\0"
};
...
const QMetaObjectExtraData pqColorButtonEventPlayer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqColorButtonEventPlayer::staticMetaObject = {
    { &pqWidgetEventPlayer::staticMetaObject, qt_meta_stringdata_pqColorButtonEventPlayer,
      qt_meta_data_pqColorButtonEventPlayer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqColorButtonEventPlayer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqColorButtonEventPlayer))
