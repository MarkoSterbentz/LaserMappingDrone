...
#include "../../../paraview/Qt/Core/pqRenderView.h"
...
static const char qt_meta_stringdata_pqRenderView[] = {
    "pqRenderView\0\0mode\0updateInteractionMode(int)\0"
    "visible\0setOrientationAxesVisibility(bool)\0"
    "interactive\0setOrientationAxesInteractivity(bool)\0"
    "setOrientationAxesLabelColor(QColor)\0"
    "setOrientationAxesOutlineColor(QColor)\0"
    "x,y,z\0setCenterOfRotation(double,double,double)\0"
    "xyz\0setCenterOfRotation(double[3])\0"
    "setCenterAxesVisibility(bool)\0b\0"
    "setResetCenterWithCamera(bool)\0"
    "setUseMultipleRepresentationSelection(bool)\0"
    "linkToOtherView()\0undo()\0redo()\0"
    "resetCenterOfRotationIfNeeded()\0opPort\0"
    "updateInteractionMode(pqOutputPort*)\0"
    "onResetCameraEvent()\0onUndoStackChanged()\0"
    "onInteractionModeChange()\0"
};
...
const QMetaObjectExtraData pqRenderView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqRenderView::staticMetaObject = {
    { &pqRenderViewBase::staticMetaObject, qt_meta_stringdata_pqRenderView,
      qt_meta_data_pqRenderView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqRenderView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqRenderView))
