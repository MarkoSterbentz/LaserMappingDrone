...
#include "../../../paraview/Qt/Core/pqPipelineRepresentation.h"
...
static const char qt_meta_stringdata_pqPipelineRepresentation[] = {
    "pqPipelineRepresentation\0\0"
    "resetLookupTableScalarRange()\0"
    "resetLookupTableScalarRangeOverTime()\0"
};
...
const QMetaObjectExtraData pqPipelineRepresentation::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqPipelineRepresentation::staticMetaObject = {
    { &pqDataRepresentation::staticMetaObject, qt_meta_stringdata_pqPipelineRepresentation,
      qt_meta_data_pqPipelineRepresentation, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqPipelineRepresentation::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqPipelineRepresentation))
        return static_cast<void*>(const_cast< pqPipelineRepresentation*>(this));
