...
#include "../../../paraview/Qt/Core/pqPipelineFilter.h"
...
static const char qt_meta_stringdata_pqPipelineFilter[] = {
    "pqPipelineFilter\0\0inputportname\0"
    "producerChanged(QString)\0,,client_data\0"
    "inputChanged(vtkObject*,ulong,void*)\0"
};
...
const QMetaObjectExtraData pqPipelineFilter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqPipelineFilter::staticMetaObject = {
    { &pqPipelineSource::staticMetaObject, qt_meta_stringdata_pqPipelineFilter,
      qt_meta_data_pqPipelineFilter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqPipelineFilter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqPipelineFilter))
        return static_cast<void*>(const_cast< pqPipelineFilter*>(this));
