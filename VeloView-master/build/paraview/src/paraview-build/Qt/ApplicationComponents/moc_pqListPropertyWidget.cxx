...
#include "../../../paraview/Qt/ApplicationComponents/pqListPropertyWidget.h"
...
static const char qt_meta_stringdata_pqListPropertyWidget[] = {
    "pqListPropertyWidget\0\0valueChanged()\0"
    "QList<QVariant>\0value\0"
};
...
const QMetaObjectExtraData pqListPropertyWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqListPropertyWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqListPropertyWidget,
      qt_meta_data_pqListPropertyWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqListPropertyWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqListPropertyWidget))
...
int pqListPropertyWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QList<QVariant>*>(_v) = value(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setValue(*reinterpret_cast< QList<QVariant>*>(_v)); break;
        }
        _id -= 1;
