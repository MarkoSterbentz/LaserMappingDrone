...
#include "../../../paraview/Qt/ApplicationComponents/pqInputDataTypeDecorator.h"
...
static const char qt_meta_stringdata_pqInputDataTypeDecorator[] = {
    "pqInputDataTypeDecorator\0"
};
...
const QMetaObjectExtraData pqInputDataTypeDecorator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqInputDataTypeDecorator::staticMetaObject = {
    { &pqPropertyWidgetDecorator::staticMetaObject, qt_meta_stringdata_pqInputDataTypeDecorator,
      qt_meta_data_pqInputDataTypeDecorator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqInputDataTypeDecorator::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqInputDataTypeDecorator))
        return static_cast<void*>(const_cast< pqInputDataTypeDecorator*>(this));
