...
#include "../../../paraview/Qt/ApplicationComponents/pqPluginActionGroupBehavior.h"
...
static const char qt_meta_stringdata_pqPluginActionGroupBehavior[] = {
    "pqPluginActionGroupBehavior\0\0iface\0"
...
const QMetaObjectExtraData pqPluginActionGroupBehavior::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqPluginActionGroupBehavior::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqPluginActionGroupBehavior,
      qt_meta_data_pqPluginActionGroupBehavior, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqPluginActionGroupBehavior::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqPluginActionGroupBehavior))
        return static_cast<void*>(const_cast< pqPluginActionGroupBehavior*>(this));
