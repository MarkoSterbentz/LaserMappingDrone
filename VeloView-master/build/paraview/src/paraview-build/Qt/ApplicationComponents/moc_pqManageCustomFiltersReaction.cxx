...
#include "../../../paraview/Qt/ApplicationComponents/pqManageCustomFiltersReaction.h"
...
static const char qt_meta_stringdata_pqManageCustomFiltersReaction[] = {
    "pqManageCustomFiltersReaction\0"
};
...
const QMetaObjectExtraData pqManageCustomFiltersReaction::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqManageCustomFiltersReaction::staticMetaObject = {
    { &pqMasterOnlyReaction::staticMetaObject, qt_meta_stringdata_pqManageCustomFiltersReaction,
      qt_meta_data_pqManageCustomFiltersReaction, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqManageCustomFiltersReaction::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqManageCustomFiltersReaction))
        return static_cast<void*>(const_cast< pqManageCustomFiltersReaction*>(this));
