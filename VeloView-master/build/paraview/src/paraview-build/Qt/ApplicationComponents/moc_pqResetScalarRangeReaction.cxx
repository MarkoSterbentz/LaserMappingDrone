...
#include "../../../paraview/Qt/ApplicationComponents/pqResetScalarRangeReaction.h"
...
static const char qt_meta_stringdata_pqResetScalarRangeReaction[] = {
    "pqResetScalarRangeReaction\0\0"
    "updateEnableState()\0"
};
...
const QMetaObjectExtraData pqResetScalarRangeReaction::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqResetScalarRangeReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqResetScalarRangeReaction,
      qt_meta_data_pqResetScalarRangeReaction, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqResetScalarRangeReaction::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqResetScalarRangeReaction))
        return static_cast<void*>(const_cast< pqResetScalarRangeReaction*>(this));
