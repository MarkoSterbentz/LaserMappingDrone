...
#include "../../../paraview/Qt/ApplicationComponents/pqGlyphScaleFactorPropertyWidget.h"
...
static const char qt_meta_stringdata_pqGlyphScaleFactorPropertyWidget[] = {
    "pqGlyphScaleFactorPropertyWidget\0\0"
...
const QMetaObjectExtraData pqGlyphScaleFactorPropertyWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqGlyphScaleFactorPropertyWidget::staticMetaObject = {
    { &pqDoubleVectorPropertyWidget::staticMetaObject, qt_meta_stringdata_pqGlyphScaleFactorPropertyWidget,
      qt_meta_data_pqGlyphScaleFactorPropertyWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqGlyphScaleFactorPropertyWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqGlyphScaleFactorPropertyWidget))
        return static_cast<void*>(const_cast< pqGlyphScaleFactorPropertyWidget*>(this));
