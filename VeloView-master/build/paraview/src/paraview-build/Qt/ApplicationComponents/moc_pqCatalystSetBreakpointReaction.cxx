...
#include "../../../paraview/Qt/ApplicationComponents/pqCatalystSetBreakpointReaction.h"
...
static const char qt_meta_stringdata_pqCatalystSetBreakpointReaction[] = {
    "pqCatalystSetBreakpointReaction\0\0"
    "updateEnableState()\0"
};
...
const QMetaObjectExtraData pqCatalystSetBreakpointReaction::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqCatalystSetBreakpointReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqCatalystSetBreakpointReaction,
      qt_meta_data_pqCatalystSetBreakpointReaction, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqCatalystSetBreakpointReaction::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqCatalystSetBreakpointReaction))
