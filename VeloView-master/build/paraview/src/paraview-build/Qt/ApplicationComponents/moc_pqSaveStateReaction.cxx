...
#include "../../../paraview/Qt/ApplicationComponents/pqSaveStateReaction.h"
...
static const char qt_meta_stringdata_pqSaveStateReaction[] = {
    "pqSaveStateReaction\0\0updateEnableState()\0"
};
...
const QMetaObjectExtraData pqSaveStateReaction::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqSaveStateReaction::staticMetaObject = {
    { &pqReaction::staticMetaObject, qt_meta_stringdata_pqSaveStateReaction,
      qt_meta_data_pqSaveStateReaction, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqSaveStateReaction::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqSaveStateReaction))
        return static_cast<void*>(const_cast< pqSaveStateReaction*>(this));
