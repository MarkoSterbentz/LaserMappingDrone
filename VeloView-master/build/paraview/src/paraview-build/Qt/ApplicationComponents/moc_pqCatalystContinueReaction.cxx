...
#include "../../../paraview/Qt/ApplicationComponents/pqCatalystContinueReaction.h"
...
static const char qt_meta_stringdata_pqCatalystContinueReaction[] = {
    "pqCatalystContinueReaction\0\0"
    "updateEnableState()\0"
};
...
const QMetaObjectExtraData pqCatalystContinueReaction::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqCatalystContinueReaction::staticMetaObject = {
    { &pqCatalystPauseSimulationReaction::staticMetaObject, qt_meta_stringdata_pqCatalystContinueReaction,
      qt_meta_data_pqCatalystContinueReaction, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqCatalystContinueReaction::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqCatalystContinueReaction))
        return static_cast<void*>(const_cast< pqCatalystContinueReaction*>(this));
