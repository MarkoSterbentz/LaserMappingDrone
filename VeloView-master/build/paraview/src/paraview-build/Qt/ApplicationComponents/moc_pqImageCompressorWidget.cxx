...
#include "../../../paraview/Qt/ApplicationComponents/pqImageCompressorWidget.h"
...
static const char qt_meta_stringdata_pqImageCompressorWidget[] = {
    "pqImageCompressorWidget\0\0"
    "compressorConfigChanged()\0"
    "setCompressorConfig(QString)\0"
    "currentIndexChanged(int)\0"
    "setConfigurationDefault(int)\0QString\0"
    "compressorConfig\0"
};
...
const QMetaObjectExtraData pqImageCompressorWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqImageCompressorWidget::staticMetaObject = {
    { &pqPropertyWidget::staticMetaObject, qt_meta_stringdata_pqImageCompressorWidget,
      qt_meta_data_pqImageCompressorWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqImageCompressorWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqImageCompressorWidget))
        return static_cast<void*>(const_cast< pqImageCompressorWidget*>(this));
...
int pqImageCompressorWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = compressorConfig(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setCompressorConfig(*reinterpret_cast< QString*>(_v)); break;
        }
        _id -= 1;
