...
#include "../../../paraview/Qt/Components/pqAboutDialog.h"
...
static const char qt_meta_stringdata_pqAboutDialog[] = {
    "pqAboutDialog\0"
};
...
const QMetaObjectExtraData pqAboutDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqAboutDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_pqAboutDialog,
      qt_meta_data_pqAboutDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqAboutDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqAboutDialog))
        return static_cast<void*>(const_cast< pqAboutDialog*>(this));
