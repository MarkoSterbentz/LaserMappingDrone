...
#include "../../../paraview/Qt/Components/pqCustomFilterManagerModel.h"
...
static const char qt_meta_stringdata_pqCustomFilterManagerModel[] = {
    "pqCustomFilterManagerModel\0\0name\0"
    "customFilterAdded(QString)\0"
    "addCustomFilter(QString)\0"
    "removeCustomFilter(QString)\0"
    "importCustomFiltersFromSettings()\0"
    "exportCustomFiltersToSettings()\0"
};
...
const QMetaObjectExtraData pqCustomFilterManagerModel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqCustomFilterManagerModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_pqCustomFilterManagerModel,
      qt_meta_data_pqCustomFilterManagerModel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqCustomFilterManagerModel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqCustomFilterManagerModel))
        return static_cast<void*>(const_cast< pqCustomFilterManagerModel*>(this));
