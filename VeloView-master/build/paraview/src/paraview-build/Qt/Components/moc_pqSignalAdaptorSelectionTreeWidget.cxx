...
#include "../../../paraview/Qt/Components/pqSignalAdaptorSelectionTreeWidget.h"
...
static const char qt_meta_stringdata_pqSignalAdaptorSelectionTreeWidget[] = {
    "pqSignalAdaptorSelectionTreeWidget\0\0"
    "valuesChanged()\0values\0"
    "setValues(QList<QList<QVariant> >)\0"
    "domainChanged()\0QList<QList<QVariant> >\0"
};
...
const QMetaObjectExtraData pqSignalAdaptorSelectionTreeWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject pqSignalAdaptorSelectionTreeWidget::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pqSignalAdaptorSelectionTreeWidget,
      qt_meta_data_pqSignalAdaptorSelectionTreeWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &pqSignalAdaptorSelectionTreeWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pqSignalAdaptorSelectionTreeWidget))
        return static_cast<void*>(const_cast< pqSignalAdaptorSelectionTreeWidget*>(this));
...
int pqSignalAdaptorSelectionTreeWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QList<QList<QVariant> >*>(_v) = values(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setValues(*reinterpret_cast< QList<QList<QVariant> >*>(_v)); break;
        }
        _id -= 1;
