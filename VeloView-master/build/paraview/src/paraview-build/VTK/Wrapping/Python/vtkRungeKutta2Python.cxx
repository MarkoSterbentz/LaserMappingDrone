...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkRungeKutta2(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkRungeKutta2New(const char *); }
...
PyvtkRungeKutta2_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkRungeKutta2::GetClassName());
...
PyvtkRungeKutta2_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkRungeKutta2 *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkRungeKutta2::NewInstance());
...
PyvtkRungeKutta2_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkRungeKutta2 *tempr = vtkRungeKutta2::SafeDownCast(temp0);
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(6) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkRungeKutta2::ComputeNextStep(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNextStep");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkRungeKutta2 *op = static_cast<vtkRungeKutta2 *>(vp);
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkRungeKutta2::ComputeNextStep(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s3(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNextStep");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkRungeKutta2 *op = static_cast<vtkRungeKutta2 *>(vp);
  ...
  if (op && ap.CheckArgCount(9) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkRungeKutta2::ComputeNextStep(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8));
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s4(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNextStep");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkRungeKutta2 *op = static_cast<vtkRungeKutta2 *>(vp);
  ...
  if (op && ap.CheckArgCount(10) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkRungeKutta2::ComputeNextStep(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9));
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep(PyObject *self, PyObject *args)
{
  ...
  switch(nargs)
    {
    case 6:
      return PyvtkRungeKutta2_ComputeNextStep_s1(self, args);
    case 7:
      return PyvtkRungeKutta2_ComputeNextStep_s2(self, args);
    case 9:
      return PyvtkRungeKutta2_ComputeNextStep_s3(self, args);
    case 10:
      return PyvtkRungeKutta2_ComputeNextStep_s4(self, args);
    }
...
static PyMethodDef PyvtkRungeKutta2_Methods[] = {
  {(char*)"GetClassName", PyvtkRungeKutta2_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkRungeKutta2_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkRungeKutta2_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkRungeKutta2\nC++: vtkRungeKutta2 *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkRungeKutta2_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkRungeKutta2\nC++: vtkRungeKutta2 *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"ComputeNextStep", PyvtkRungeKutta2_ComputeNextStep, METH_VARARGS,
