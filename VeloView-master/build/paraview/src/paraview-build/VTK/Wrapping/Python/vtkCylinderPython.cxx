...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkCylinder(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkCylinderNew(const char *); }
...
static PyMethodDef PyvtkCylinder_Methods[] = {
  {(char*)"GetClassName", PyvtkCylinder_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkCylinder_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkCylinder_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkCylinder\nC++: vtkCylinder *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkCylinder_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkCylinder\nC++: vtkCylinder *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"EvaluateFunction", PyvtkCylinder_EvaluateFunction, METH_VARARGS,
  ...
  {(char*)"EvaluateGradient", PyvtkCylinder_EvaluateGradient, METH_VARARGS,
   (char*)"V.EvaluateGradient([float, float, float], [float, float, float])\nC++: void EvaluateGradient(double x[3], double g[3])\n\n"},
  {(char*)"SetRadius", PyvtkCylinder_SetRadius, METH_VARARGS,
   (char*)"V.SetRadius(float)\nC++: void SetRadius(double a)\n\nSet/Get cylinder radius.\n"},
  {(char*)"GetRadius", PyvtkCylinder_GetRadius, METH_VARARGS,
   (char*)"V.GetRadius() -> float\nC++: double GetRadius()\n\nSet/Get cylinder radius.\n"},
  {(char*)"SetCenter", PyvtkCylinder_SetCenter, METH_VARARGS,
   (char*)"V.SetCenter(float, float, float)\nC++: void SetCenter(double, double, double)\nV.SetCenter((float, float, float))\nC++: void SetCenter(double a[3])\n\n"},
  {(char*)"GetCenter", PyvtkCylinder_GetCenter, METH_VARARGS,
