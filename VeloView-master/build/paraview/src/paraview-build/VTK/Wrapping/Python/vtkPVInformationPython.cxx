...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkPVInformation(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkPVInformationNew(const char *); }
...
static PyObject *
PyvtkPVInformation_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkPVInformation::GetClassName());
...
static PyObject *
PyvtkPVInformation_CopyToStream(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkPVInformation_CopyFromStream(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPVInformation::CopyFromStream(temp0);
      }
...
static PyMethodDef PyvtkPVInformation_Methods[] = {
  {(char*)"GetClassName", PyvtkPVInformation_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPVInformation_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPVInformation_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkPVInformation\nC++: vtkPVInformation *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPVInformation_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPVInformation\nC++: vtkPVInformation *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"CopyFromObject", PyvtkPVInformation_CopyFromObject, METH_VARARGS,
   (char*)"V.CopyFromObject(vtkObject)\nC++: virtual void CopyFromObject(vtkObject *)\n\nTransfer information about a single object into this object.\n"},
  {(char*)"AddInformation", PyvtkPVInformation_AddInformation, METH_VARARGS,
   (char*)"V.AddInformation(vtkPVInformation)\nC++: virtual void AddInformation(vtkPVInformation *)\n\nMerge another information object.\n"},
  {(char*)"CopyToStream", PyvtkPVInformation_CopyToStream, METH_VARARGS,
   (char*)"V.CopyToStream(vtkClientServerStream)\nC++: virtual void CopyToStream(vtkClientServerStream *)\n\nManage a serialized version of the information.\n"},
  {(char*)"CopyFromStream", PyvtkPVInformation_CopyFromStream, METH_VARARGS,
   (char*)"V.CopyFromStream(vtkClientServerStream)\nC++: virtual void CopyFromStream(const vtkClientServerStream *)\n\nManage a serialized version of the information.\n"},
  {(char*)"GetRootOnly", PyvtkPVInformation_GetRootOnly, METH_VARARGS,
   (char*)"V.GetRootOnly() -> int\nC++: int GetRootOnly()\n\nSet/get whether to gather information only from the root.\n"},
  {NULL, NULL, 0, NULL}
};

PyObject *PyVTKClass_vtkPVInformationNew(const char *modulename)
{
  PyObject *cls = PyVTKClass_New(NULL,
    PyvtkPVInformation_Methods,
    "vtkPVInformation", modulename,
    NULL, NULL,
    PyvtkPVInformation_Doc(),
    PyVTKClass_vtkObjectNew(modulename));
  return cls;
}

const char **PyvtkPVInformation_Doc()
{
...
{
  PyObject *o;
  o = PyVTKClass_vtkPVInformationNew(modulename);

  if (o && PyDict_SetItemString(dict, (char *)"vtkPVInformation", o) != 0)
    {
    Py_DECREF(o);
    }
