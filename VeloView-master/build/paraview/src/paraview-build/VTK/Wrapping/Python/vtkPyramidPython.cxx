...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkPyramid(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkPyramidNew(const char *); }
...
PyvtkPyramid_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkPyramid *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkPyramid::NewInstance());
...
PyvtkPyramid_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkPyramid *tempr = vtkPyramid::SafeDownCast(temp0);
...
PyvtkPyramid_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkPyramid::GetCellDimension());
...
PyvtkPyramid_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkPyramid::GetNumberOfEdges());
...
PyvtkPyramid_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkPyramid::GetNumberOfFaces());
...
PyvtkPyramid_CellBoundary(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkPyramid_EvaluatePosition(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(6) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkPyramid_EvaluateLocation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPyramid::EvaluateLocation(temp0, temp1, temp2, temp3);
      }
...
PyvtkPyramid_IntersectWithLine(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
PyvtkPyramid_Triangulate(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkPyramid_Derivatives(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(5) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPyramid::Derivatives(temp0, temp1, temp2, temp3, temp4);
      }
...
static PyObject *
PyvtkPyramid_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetParametricCoords());
...
PyvtkPyramid_GetParametricCenter(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetParametricCenter(temp0));
...
PyvtkPyramid_GetEdgeArray(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    int *tempr = vtkPyramid::GetEdgeArray(temp0);
...
PyvtkPyramid_GetFaceArray(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    int *tempr = vtkPyramid::GetFaceArray(temp0);
...
static PyMethodDef PyvtkPyramid_Methods[] = {
  {(char*)"GetClassName", PyvtkPyramid_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPyramid_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPyramid_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkPyramid\nC++: vtkPyramid *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPyramid_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPyramid\nC++: vtkPyramid *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetCellType", PyvtkPyramid_GetCellType, METH_VARARGS,
   (char*)"V.GetCellType() -> int\nC++: int GetCellType()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetCellDimension", PyvtkPyramid_GetCellDimension, METH_VARARGS,
   (char*)"V.GetCellDimension() -> int\nC++: int GetCellDimension()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetNumberOfEdges", PyvtkPyramid_GetNumberOfEdges, METH_VARARGS,
   (char*)"V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetNumberOfFaces", PyvtkPyramid_GetNumberOfFaces, METH_VARARGS,
   (char*)"V.GetNumberOfFaces() -> int\nC++: int GetNumberOfFaces()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetEdge", PyvtkPyramid_GetEdge, METH_VARARGS,
   (char*)"V.GetEdge(int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetFace", PyvtkPyramid_GetFace, METH_VARARGS,
   (char*)"V.GetFace(int) -> vtkCell\nC++: vtkCell *GetFace(int faceId)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"CellBoundary", PyvtkPyramid_CellBoundary, METH_VARARGS,
   (char*)"V.CellBoundary(int, [float, float, float], vtkIdList) -> int\nC++: int CellBoundary(int subId, double pcoords[3],\n    vtkIdList *pts)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"Contour", PyvtkPyramid_Contour, METH_VARARGS,
   (char*)"V.Contour(float, vtkDataArray, vtkIncrementalPointLocator,\n    vtkCellArray, vtkCellArray, vtkCellArray, vtkPointData,\n    vtkPointData, vtkCellData, int, vtkCellData)\nC++: void Contour(double value, vtkDataArray *cellScalars,\n    vtkIncrementalPointLocator *locator, vtkCellArray *verts,\n    vtkCellArray *lines, vtkCellArray *polys, vtkPointData *inPd,\n    vtkPointData *outPd, vtkCellData *inCd, vtkIdType cellId,\n    vtkCellData *outCd)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"EvaluatePosition", PyvtkPyramid_EvaluatePosition, METH_VARARGS,
  ...
  {(char*)"EvaluateLocation", PyvtkPyramid_EvaluateLocation, METH_VARARGS,
   (char*)"V.EvaluateLocation(int, [float, float, float], [float, float,\n    float], [float, ...])\nC++: void EvaluateLocation(int &subId, double pcoords[3],\n    double x[3], double *weights)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"IntersectWithLine", PyvtkPyramid_IntersectWithLine, METH_VARARGS,
  ...
  {(char*)"Triangulate", PyvtkPyramid_Triangulate, METH_VARARGS,
   (char*)"V.Triangulate(int, vtkIdList, vtkPoints) -> int\nC++: int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"Derivatives", PyvtkPyramid_Derivatives, METH_VARARGS,
   (char*)"V.Derivatives(int, [float, float, float], [float, ...], int,\n    [float, ...])\nC++: void Derivatives(int subId, double pcoords[3],\n    double *values, int dim, double *derivs)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetParametricCoords", PyvtkPyramid_GetParametricCoords, METH_VARARGS,
   (char*)"V.GetParametricCoords() -> (float, ...)\nC++: virtual double *GetParametricCoords()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetParametricCenter", PyvtkPyramid_GetParametricCenter, METH_VARARGS,
   (char*)"V.GetParametricCenter([float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3])\n\nReturn the center of the pyramid in parametric coordinates.\n"},
  {(char*)"InterpolationFunctions", PyvtkPyramid_InterpolationFunctions, METH_VARARGS | METH_STATIC,
  ...
  {(char*)"InterpolationDerivs", PyvtkPyramid_InterpolationDerivs, METH_VARARGS | METH_STATIC,
  ...
  {(char*)"InterpolateFunctions", PyvtkPyramid_InterpolateFunctions, METH_VARARGS,
  ...
  {(char*)"InterpolateDerivs", PyvtkPyramid_InterpolateDerivs, METH_VARARGS,
   (char*)"V.InterpolateDerivs([float, float, float], [float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float])\nC++: virtual void InterpolateDerivs(double pcoords[3],\n    double derivs[15])\n\nCompute the interpolation functions/derivatives (aka shape\nfunctions/derivatives)\n"},
  {(char*)"GetEdgeArray", PyvtkPyramid_GetEdgeArray, METH_VARARGS | METH_STATIC,
  ...
  {(char*)"GetFaceArray", PyvtkPyramid_GetFaceArray, METH_VARARGS | METH_STATIC,
