...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkDataObjectAlgorithm(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkDataObjectAlgorithmNew(const char *); }
...
PyvtkDataObjectAlgorithm_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkDataObjectAlgorithm::GetClassName());
...
PyvtkDataObjectAlgorithm_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkDataObjectAlgorithm::IsA(temp0));
...
PyvtkDataObjectAlgorithm_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkDataObjectAlgorithm *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkDataObjectAlgorithm::NewInstance());
...
PyvtkDataObjectAlgorithm_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkDataObjectAlgorithm *tempr = vtkDataObjectAlgorithm::SafeDownCast(temp0);
...
PyvtkDataObjectAlgorithm_GetOutput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    vtkDataObject *tempr = (ap.IsBound() ?
      op->GetOutput() :
      op->vtkDataObjectAlgorithm::GetOutput());
...
PyvtkDataObjectAlgorithm_GetOutput_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    vtkDataObject *tempr = (ap.IsBound() ?
      op->GetOutput(temp0) :
      op->vtkDataObjectAlgorithm::GetOutput(temp0));
...
PyvtkDataObjectAlgorithm_GetInput_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    vtkDataObject *tempr = (ap.IsBound() ?
      op->GetInput() :
      op->vtkDataObjectAlgorithm::GetInput());
...
PyvtkDataObjectAlgorithm_GetInput_s2(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    vtkDataObject *tempr = (ap.IsBound() ?
      op->GetInput(temp0) :
      op->vtkDataObjectAlgorithm::GetInput(temp0));
...
static PyObject *
PyvtkDataObjectAlgorithm_SetInputData_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkDataObjectAlgorithm::SetInputData(temp0);
      }
...
static PyObject *
PyvtkDataObjectAlgorithm_SetInputData_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SetInputData");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDataObjectAlgorithm *op = static_cast<vtkDataObjectAlgorithm *>(vp);
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkDataObjectAlgorithm::SetInputData(temp0, temp1);
      }
...
static PyObject *
PyvtkDataObjectAlgorithm_SetInputData(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  switch(nargs)
    {
    case 1:
      return PyvtkDataObjectAlgorithm_SetInputData_s1(self, args);
    case 2:
      return PyvtkDataObjectAlgorithm_SetInputData_s2(self, args);
    }
...
static PyObject *
PyvtkDataObjectAlgorithm_AddInputData_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkDataObjectAlgorithm::AddInputData(temp0);
      }
...
static PyObject *
PyvtkDataObjectAlgorithm_AddInputData_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "AddInputData");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkDataObjectAlgorithm *op = static_cast<vtkDataObjectAlgorithm *>(vp);
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkDataObjectAlgorithm::AddInputData(temp0, temp1);
      }
...
static PyObject *
PyvtkDataObjectAlgorithm_AddInputData(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  switch(nargs)
    {
    case 1:
      return PyvtkDataObjectAlgorithm_AddInputData_s1(self, args);
    case 2:
      return PyvtkDataObjectAlgorithm_AddInputData_s2(self, args);
    }
...
static PyMethodDef PyvtkDataObjectAlgorithm_Methods[] = {
  {(char*)"GetClassName", PyvtkDataObjectAlgorithm_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkDataObjectAlgorithm_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkDataObjectAlgorithm_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkDataObjectAlgorithm\nC++: vtkDataObjectAlgorithm *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkDataObjectAlgorithm_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkDataObjectAlgorithm\nC++: vtkDataObjectAlgorithm *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetOutput", PyvtkDataObjectAlgorithm_GetOutput, METH_VARARGS,
  ...
  {(char*)"SetOutput", PyvtkDataObjectAlgorithm_SetOutput, METH_VARARGS,
   (char*)"V.SetOutput(vtkDataObject)\nC++: virtual void SetOutput(vtkDataObject *d)\n\nGet the output data object for a port on this algorithm.\n"},
  {(char*)"GetInput", PyvtkDataObjectAlgorithm_GetInput, METH_VARARGS,
   (char*)"V.GetInput() -> vtkDataObject\nC++: vtkDataObject *GetInput()\nV.GetInput(int) -> vtkDataObject\nC++: vtkDataObject *GetInput(int port)\n\n"},
  {(char*)"SetInputData", PyvtkDataObjectAlgorithm_SetInputData, METH_VARARGS,
   (char*)"V.SetInputData(vtkDataObject)\nC++: void SetInputData(vtkDataObject *)\nV.SetInputData(int, vtkDataObject)\nC++: void SetInputData(int, vtkDataObject *)\n\nAssign a data object as input. Note that this method does not\nestablish a pipeline connection. Use SetInputConnection() to\nsetup a pipeline connection.\n"},
  {(char*)"AddInputData", PyvtkDataObjectAlgorithm_AddInputData, METH_VARARGS,
