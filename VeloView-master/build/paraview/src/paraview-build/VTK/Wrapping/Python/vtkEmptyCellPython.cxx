...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkEmptyCell(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkEmptyCellNew(const char *); }
...
static PyObject *
PyvtkEmptyCell_GetClassName(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkEmptyCell_InterpolateFunctions(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkEmptyCell::InterpolateFunctions(temp0, temp1);
      }
...
static PyObject *
PyvtkEmptyCell_InterpolateDerivs(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkEmptyCell::InterpolateDerivs(temp0, temp1);
      }
...
static PyMethodDef PyvtkEmptyCell_Methods[] = {
  {(char*)"GetClassName", PyvtkEmptyCell_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkEmptyCell_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkEmptyCell_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkEmptyCell\nC++: vtkEmptyCell *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkEmptyCell_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkEmptyCell\nC++: vtkEmptyCell *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetCellType", PyvtkEmptyCell_GetCellType, METH_VARARGS,
   (char*)"V.GetCellType() -> int\nC++: int GetCellType()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetCellDimension", PyvtkEmptyCell_GetCellDimension, METH_VARARGS,
   (char*)"V.GetCellDimension() -> int\nC++: int GetCellDimension()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetNumberOfEdges", PyvtkEmptyCell_GetNumberOfEdges, METH_VARARGS,
   (char*)"V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetNumberOfFaces", PyvtkEmptyCell_GetNumberOfFaces, METH_VARARGS,
   (char*)"V.GetNumberOfFaces() -> int\nC++: int GetNumberOfFaces()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetEdge", PyvtkEmptyCell_GetEdge, METH_VARARGS,
   (char*)"V.GetEdge(int) -> vtkCell\nC++: vtkCell *GetEdge(int)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetFace", PyvtkEmptyCell_GetFace, METH_VARARGS,
   (char*)"V.GetFace(int) -> vtkCell\nC++: vtkCell *GetFace(int)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"CellBoundary", PyvtkEmptyCell_CellBoundary, METH_VARARGS,
   (char*)"V.CellBoundary(int, [float, float, float], vtkIdList) -> int\nC++: int CellBoundary(int subId, double pcoords[3],\n    vtkIdList *pts)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"Contour", PyvtkEmptyCell_Contour, METH_VARARGS,
  ...
  {(char*)"Clip", PyvtkEmptyCell_Clip, METH_VARARGS,
  ...
  {(char*)"EvaluatePosition", PyvtkEmptyCell_EvaluatePosition, METH_VARARGS,
  ...
  {(char*)"EvaluateLocation", PyvtkEmptyCell_EvaluateLocation, METH_VARARGS,
   (char*)"V.EvaluateLocation(int, [float, float, float], [float, float,\n    float], [float, ...])\nC++: void EvaluateLocation(int &subId, double pcoords[3],\n    double x[3], double *weights)\n\n"},
  {(char*)"IntersectWithLine", PyvtkEmptyCell_IntersectWithLine, METH_VARARGS,
...
PyObject *PyVTKClass_vtkEmptyCellNew(const char *modulename)
{
  PyObject *cls = PyVTKClass_New(&PyvtkEmptyCell_StaticNew,
    PyvtkEmptyCell_Methods,
    "vtkEmptyCell", modulename,
    NULL, NULL,
    PyvtkEmptyCell_Doc(),
...
{
  PyObject *o;
  o = PyVTKClass_vtkEmptyCellNew(modulename);

  if (o && PyDict_SetItemString(dict, (char *)"vtkEmptyCell", o) != 0)
    {
    Py_DECREF(o);
    }
