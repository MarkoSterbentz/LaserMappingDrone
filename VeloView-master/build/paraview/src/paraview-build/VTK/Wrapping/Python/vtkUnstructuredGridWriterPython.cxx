...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkUnstructuredGridWriter(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkUnstructuredGridWriterNew(const char *); }
...
PyvtkUnstructuredGridWriter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkUnstructuredGridWriter::GetClassName());
...
static PyMethodDef PyvtkUnstructuredGridWriter_Methods[] = {
  {(char*)"GetClassName", PyvtkUnstructuredGridWriter_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkUnstructuredGridWriter_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkUnstructuredGridWriter_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkUnstructuredGridWriter\nC++: vtkUnstructuredGridWriter *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkUnstructuredGridWriter_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkUnstructuredGridWriter\nC++: vtkUnstructuredGridWriter *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetInput", PyvtkUnstructuredGridWriter_GetInput, METH_VARARGS,
