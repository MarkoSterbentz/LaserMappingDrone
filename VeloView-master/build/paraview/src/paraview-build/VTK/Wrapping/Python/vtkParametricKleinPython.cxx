...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkParametricKlein(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkParametricKleinNew(const char *); }
...
PyvtkParametricKlein_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkParametricKlein::GetClassName());
...
PyvtkParametricKlein_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkParametricKlein::IsA(temp0));
...
PyvtkParametricKlein_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkParametricKlein *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkParametricKlein::NewInstance());
...
PyvtkParametricKlein_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkParametricKlein *tempr = vtkParametricKlein::SafeDownCast(temp0);
...
PyvtkParametricKlein_GetDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetDimension() :
      op->vtkParametricKlein::GetDimension());
...
PyvtkParametricKlein_EvaluateScalar(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    double tempr = (ap.IsBound() ?
      ...
      op->vtkParametricKlein::EvaluateScalar(temp0, temp1, temp2));
...
static PyMethodDef PyvtkParametricKlein_Methods[] = {
  {(char*)"GetClassName", PyvtkParametricKlein_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkParametricKlein_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkParametricKlein_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkParametricKlein\nC++: vtkParametricKlein *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkParametricKlein_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkParametricKlein\nC++: vtkParametricKlein *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetDimension", PyvtkParametricKlein_GetDimension, METH_VARARGS,
   (char*)"V.GetDimension() -> int\nC++: virtual int GetDimension()\n\n"},
  {(char*)"Evaluate", PyvtkParametricKlein_Evaluate, METH_VARARGS,
  ...
  {(char*)"EvaluateScalar", PyvtkParametricKlein_EvaluateScalar, METH_VARARGS,
