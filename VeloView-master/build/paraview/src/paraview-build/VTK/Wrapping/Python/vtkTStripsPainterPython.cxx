...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkTStripsPainter(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkTStripsPainterNew(const char *); }
...
PyvtkTStripsPainter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkTStripsPainter::GetClassName());
...
PyvtkTStripsPainter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkTStripsPainter::IsA(temp0));
...
PyvtkTStripsPainter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkTStripsPainter *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkTStripsPainter::NewInstance());
...
PyvtkTStripsPainter_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkTStripsPainter *tempr = vtkTStripsPainter::SafeDownCast(temp0);
...
static PyMethodDef PyvtkTStripsPainter_Methods[] = {
  {(char*)"GetClassName", PyvtkTStripsPainter_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkTStripsPainter_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkTStripsPainter_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkTStripsPainter\nC++: vtkTStripsPainter *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkTStripsPainter_SafeDownCast, METH_VARARGS | METH_STATIC,
