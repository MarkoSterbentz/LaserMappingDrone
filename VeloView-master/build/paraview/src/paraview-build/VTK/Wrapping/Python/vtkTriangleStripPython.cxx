...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkTriangleStrip(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkTriangleStripNew(const char *); }
...
PyvtkTriangleStrip_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkTriangleStrip::GetClassName());
...
PyvtkTriangleStrip_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkTriangleStrip *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkTriangleStrip::NewInstance());
...
PyvtkTriangleStrip_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkTriangleStrip *tempr = vtkTriangleStrip::SafeDownCast(temp0);
...
PyvtkTriangleStrip_GetCellType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetCellType() :
      op->vtkTriangleStrip::GetCellType());
...
PyvtkTriangleStrip_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkTriangleStrip::GetCellDimension());
...
PyvtkTriangleStrip_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkTriangleStrip::GetNumberOfEdges());
...
PyvtkTriangleStrip_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkTriangleStrip::GetNumberOfFaces());
...
PyvtkTriangleStrip_GetEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    vtkCell *tempr = (ap.IsBound() ?
      op->GetEdge(temp0) :
      op->vtkTriangleStrip::GetEdge(temp0));
...
PyvtkTriangleStrip_GetFace(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    vtkCell *tempr = (ap.IsBound() ?
      op->GetFace(temp0) :
      op->vtkTriangleStrip::GetFace(temp0));
...
PyvtkTriangleStrip_CellBoundary(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkTriangleStrip::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkTriangleStrip_EvaluatePosition(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(6) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkTriangleStrip::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkTriangleStrip_EvaluateLocation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkTriangleStrip::EvaluateLocation(temp0, temp1, temp2, temp3);
      }
...
PyvtkTriangleStrip_IntersectWithLine(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkTriangleStrip::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
PyvtkTriangleStrip_Triangulate(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkTriangleStrip::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkTriangleStrip_Derivatives(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(5) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkTriangleStrip::Derivatives(temp0, temp1, temp2, temp3, temp4);
      }
...
PyvtkTriangleStrip_IsPrimaryCell(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->IsPrimaryCell() :
      op->vtkTriangleStrip::IsPrimaryCell());
...
PyvtkTriangleStrip_GetParametricCenter(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkTriangleStrip::GetParametricCenter(temp0));
...
static PyObject *
PyvtkTriangleStrip_DecomposeStrip(PyObject *, PyObject *args)
{
  vtkPythonArgs ap(args, "DecomposeStrip");
  ...
  if (ap.CheckArgCount(3) &&
    ...
    vtkTriangleStrip::DecomposeStrip(temp0, temp1, temp2);
...
static PyObject *
PyvtkTriangleStrip_InterpolateFunctions(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkTriangleStrip::InterpolateFunctions(temp0, temp1);
      }
...
static PyObject *
PyvtkTriangleStrip_InterpolateDerivs(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(2) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkTriangleStrip::InterpolateDerivs(temp0, temp1);
      }
...
static PyMethodDef PyvtkTriangleStrip_Methods[] = {
  {(char*)"GetClassName", PyvtkTriangleStrip_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkTriangleStrip_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkTriangleStrip_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkTriangleStrip\nC++: vtkTriangleStrip *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkTriangleStrip_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkTriangleStrip\nC++: vtkTriangleStrip *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetCellType", PyvtkTriangleStrip_GetCellType, METH_VARARGS,
   (char*)"V.GetCellType() -> int\nC++: int GetCellType()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetCellDimension", PyvtkTriangleStrip_GetCellDimension, METH_VARARGS,
   (char*)"V.GetCellDimension() -> int\nC++: int GetCellDimension()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetNumberOfEdges", PyvtkTriangleStrip_GetNumberOfEdges, METH_VARARGS,
   (char*)"V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetNumberOfFaces", PyvtkTriangleStrip_GetNumberOfFaces, METH_VARARGS,
   (char*)"V.GetNumberOfFaces() -> int\nC++: int GetNumberOfFaces()\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetEdge", PyvtkTriangleStrip_GetEdge, METH_VARARGS,
   (char*)"V.GetEdge(int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"GetFace", PyvtkTriangleStrip_GetFace, METH_VARARGS,
   (char*)"V.GetFace(int) -> vtkCell\nC++: vtkCell *GetFace(int faceId)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"CellBoundary", PyvtkTriangleStrip_CellBoundary, METH_VARARGS,
   (char*)"V.CellBoundary(int, [float, float, float], vtkIdList) -> int\nC++: int CellBoundary(int subId, double pcoords[3],\n    vtkIdList *pts)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"Contour", PyvtkTriangleStrip_Contour, METH_VARARGS,
   (char*)"V.Contour(float, vtkDataArray, vtkIncrementalPointLocator,\n    vtkCellArray, vtkCellArray, vtkCellArray, vtkPointData,\n    vtkPointData, vtkCellData, int, vtkCellData)\nC++: void Contour(double value, vtkDataArray *cellScalars,\n    vtkIncrementalPointLocator *locator, vtkCellArray *verts,\n    vtkCellArray *lines, vtkCellArray *polys, vtkPointData *inPd,\n    vtkPointData *outPd, vtkCellData *inCd, vtkIdType cellId,\n    vtkCellData *outCd)\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {(char*)"Clip", PyvtkTriangleStrip_Clip, METH_VARARGS,
  ...
  {(char*)"EvaluatePosition", PyvtkTriangleStrip_EvaluatePosition, METH_VARARGS,
  ...
  {(char*)"EvaluateLocation", PyvtkTriangleStrip_EvaluateLocation, METH_VARARGS,
   (char*)"V.EvaluateLocation(int, [float, float, float], [float, float,\n    float], [float, ...])\nC++: void EvaluateLocation(int &subId, double pcoords[3],\n    double x[3], double *weights)\n\n"},
  {(char*)"IntersectWithLine", PyvtkTriangleStrip_IntersectWithLine, METH_VARARGS,
  ...
  {(char*)"Triangulate", PyvtkTriangleStrip_Triangulate, METH_VARARGS,
   (char*)"V.Triangulate(int, vtkIdList, vtkPoints) -> int\nC++: int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)\n\n"},
  {(char*)"Derivatives", PyvtkTriangleStrip_Derivatives, METH_VARARGS,
   (char*)"V.Derivatives(int, [float, float, float], [float, ...], int,\n    [float, ...])\nC++: void Derivatives(int subId, double pcoords[3],\n    double *values, int dim, double *derivs)\n\n"},
  {(char*)"IsPrimaryCell", PyvtkTriangleStrip_IsPrimaryCell, METH_VARARGS,
   (char*)"V.IsPrimaryCell() -> int\nC++: int IsPrimaryCell()\n\n"},
  {(char*)"GetParametricCenter", PyvtkTriangleStrip_GetParametricCenter, METH_VARARGS,
   (char*)"V.GetParametricCenter([float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3])\n\nReturn the center of the point cloud in parametric coordinates.\n"},
  {(char*)"DecomposeStrip", PyvtkTriangleStrip_DecomposeStrip, METH_VARARGS | METH_STATIC,
   (char*)"V.DecomposeStrip(int, [int, ...], vtkCellArray)\nC++: static void DecomposeStrip(int npts, vtkIdType *pts,\n    vtkCellArray *tris)\n\nGiven a triangle strip, decompose it into a list of (triangle)\npolygons. The polygons are appended to the end of the list of\ntriangles.\n"},
  {(char*)"InterpolateFunctions", PyvtkTriangleStrip_InterpolateFunctions, METH_VARARGS,
   (char*)"V.InterpolateFunctions([float, float, float], [float, ...])\nC++: virtual void InterpolateFunctions(double pcoords[3],\n    double *weights)\n\nCompute the interpolation functions/derivatives (aka shape\nfunctions/derivatives)\n"},
  {(char*)"InterpolateDerivs", PyvtkTriangleStrip_InterpolateDerivs, METH_VARARGS,
