...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkQuadraticLinearQuad(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkQuadraticLinearQuadNew(const char *); }
...
PyvtkQuadraticLinearQuad_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkQuadraticLinearQuad::GetClassName());
...
PyvtkQuadraticLinearQuad_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkQuadraticLinearQuad::IsA(temp0));
...
PyvtkQuadraticLinearQuad_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkQuadraticLinearQuad *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkQuadraticLinearQuad::NewInstance());
...
PyvtkQuadraticLinearQuad_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkQuadraticLinearQuad *tempr = vtkQuadraticLinearQuad::SafeDownCast(temp0);
...
PyvtkQuadraticLinearQuad_GetCellType(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetCellType() :
      op->vtkQuadraticLinearQuad::GetCellType());
...
PyvtkQuadraticLinearQuad_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkQuadraticLinearQuad::GetCellDimension());
...
PyvtkQuadraticLinearQuad_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkQuadraticLinearQuad::GetNumberOfEdges());
...
PyvtkQuadraticLinearQuad_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkQuadraticLinearQuad::GetNumberOfFaces());
...
PyvtkQuadraticLinearQuad_GetEdge(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    vtkCell *tempr = (ap.IsBound() ?
      op->GetEdge(temp0) :
      op->vtkQuadraticLinearQuad::GetEdge(temp0));
...
PyvtkQuadraticLinearQuad_GetFace(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    vtkCell *tempr = (ap.IsBound() ?
      op->GetFace(temp0) :
      op->vtkQuadraticLinearQuad::GetFace(temp0));
...
PyvtkQuadraticLinearQuad_CellBoundary(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticLinearQuad::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkQuadraticLinearQuad_EvaluatePosition(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(6) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticLinearQuad::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkQuadraticLinearQuad_EvaluateLocation(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(4) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkQuadraticLinearQuad::EvaluateLocation(temp0, temp1, temp2, temp3);
      }
...
PyvtkQuadraticLinearQuad_Triangulate(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(3) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticLinearQuad::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkQuadraticLinearQuad_Derivatives(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(5) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkQuadraticLinearQuad::Derivatives(temp0, temp1, temp2, temp3, temp4);
      }
...
static PyObject *
PyvtkQuadraticLinearQuad_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticLinearQuad::GetParametricCoords());
...
PyvtkQuadraticLinearQuad_IntersectWithLine(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(7) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticLinearQuad::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
PyvtkQuadraticLinearQuad_GetParametricCenter(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticLinearQuad::GetParametricCenter(temp0));
...
static PyObject *
PyvtkQuadraticLinearQuad_GetEdgeArray(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
    {
    int *tempr = vtkQuadraticLinearQuad::GetEdgeArray(temp0);
...
static PyMethodDef PyvtkQuadraticLinearQuad_Methods[] = {
  {(char*)"GetClassName", PyvtkQuadraticLinearQuad_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkQuadraticLinearQuad_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkQuadraticLinearQuad_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkQuadraticLinearQuad\nC++: vtkQuadraticLinearQuad *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkQuadraticLinearQuad_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkQuadraticLinearQuad\nC++: vtkQuadraticLinearQuad *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"GetCellType", PyvtkQuadraticLinearQuad_GetCellType, METH_VARARGS,
   (char*)"V.GetCellType() -> int\nC++: int GetCellType()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetCellDimension", PyvtkQuadraticLinearQuad_GetCellDimension, METH_VARARGS,
   (char*)"V.GetCellDimension() -> int\nC++: int GetCellDimension()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetNumberOfEdges", PyvtkQuadraticLinearQuad_GetNumberOfEdges, METH_VARARGS,
   (char*)"V.GetNumberOfEdges() -> int\nC++: int GetNumberOfEdges()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetNumberOfFaces", PyvtkQuadraticLinearQuad_GetNumberOfFaces, METH_VARARGS,
   (char*)"V.GetNumberOfFaces() -> int\nC++: int GetNumberOfFaces()\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetEdge", PyvtkQuadraticLinearQuad_GetEdge, METH_VARARGS,
   (char*)"V.GetEdge(int) -> vtkCell\nC++: vtkCell *GetEdge(int)\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"GetFace", PyvtkQuadraticLinearQuad_GetFace, METH_VARARGS,
   (char*)"V.GetFace(int) -> vtkCell\nC++: vtkCell *GetFace(int)\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {(char*)"CellBoundary", PyvtkQuadraticLinearQuad_CellBoundary, METH_VARARGS,
   (char*)"V.CellBoundary(int, [float, float, float], vtkIdList) -> int\nC++: int CellBoundary(int subId, double pcoords[3],\n    vtkIdList *pts)\n\n"},
  {(char*)"Contour", PyvtkQuadraticLinearQuad_Contour, METH_VARARGS,
   (char*)"V.Contour(float, vtkDataArray, vtkIncrementalPointLocator,\n    vtkCellArray, vtkCellArray, vtkCellArray, vtkPointData,\n    vtkPointData, vtkCellData, int, vtkCellData)\nC++: void Contour(double value, vtkDataArray *cellScalars,\n    vtkIncrementalPointLocator *locator, vtkCellArray *verts,\n    vtkCellArray *lines, vtkCellArray *polys, vtkPointData *inPd,\n    vtkPointData *outPd, vtkCellData *inCd, vtkIdType cellId,\n    vtkCellData *outCd)\n\n"},
  {(char*)"EvaluatePosition", PyvtkQuadraticLinearQuad_EvaluatePosition, METH_VARARGS,
  ...
  {(char*)"EvaluateLocation", PyvtkQuadraticLinearQuad_EvaluateLocation, METH_VARARGS,
   (char*)"V.EvaluateLocation(int, [float, float, float], [float, float,\n    float], [float, ...])\nC++: void EvaluateLocation(int &subId, double pcoords[3],\n    double x[3], double *weights)\n\n"},
  {(char*)"Triangulate", PyvtkQuadraticLinearQuad_Triangulate, METH_VARARGS,
   (char*)"V.Triangulate(int, vtkIdList, vtkPoints) -> int\nC++: int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)\n\n"},
  {(char*)"Derivatives", PyvtkQuadraticLinearQuad_Derivatives, METH_VARARGS,
   (char*)"V.Derivatives(int, [float, float, float], [float, ...], int,\n    [float, ...])\nC++: void Derivatives(int subId, double pcoords[3],\n    double *values, int dim, double *derivs)\n\n"},
  {(char*)"GetParametricCoords", PyvtkQuadraticLinearQuad_GetParametricCoords, METH_VARARGS,
   (char*)"V.GetParametricCoords() -> (float, ...)\nC++: virtual double *GetParametricCoords()\n\n"},
  {(char*)"Clip", PyvtkQuadraticLinearQuad_Clip, METH_VARARGS,
  ...
  {(char*)"IntersectWithLine", PyvtkQuadraticLinearQuad_IntersectWithLine, METH_VARARGS,
  ...
  {(char*)"GetParametricCenter", PyvtkQuadraticLinearQuad_GetParametricCenter, METH_VARARGS,
   (char*)"V.GetParametricCenter([float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3])\n\nReturn the center of the pyramid in parametric coordinates.\n"},
  {(char*)"InterpolationFunctions", PyvtkQuadraticLinearQuad_InterpolationFunctions, METH_VARARGS | METH_STATIC,
  ...
  {(char*)"InterpolationDerivs", PyvtkQuadraticLinearQuad_InterpolationDerivs, METH_VARARGS | METH_STATIC,
  ...
  {(char*)"InterpolateFunctions", PyvtkQuadraticLinearQuad_InterpolateFunctions, METH_VARARGS,
  ...
  {(char*)"InterpolateDerivs", PyvtkQuadraticLinearQuad_InterpolateDerivs, METH_VARARGS,
   (char*)"V.InterpolateDerivs([float, float, float], [float, float, float,\n    float, float, float, float, float, float, float, float,\n    float])\nC++: virtual void InterpolateDerivs(double pcoords[3],\n    double derivs[12])\n\nCompute the interpolation functions/derivatives (aka shape\nfunctions/derivatives)\n"},
  {(char*)"GetEdgeArray", PyvtkQuadraticLinearQuad_GetEdgeArray, METH_VARARGS | METH_STATIC,
