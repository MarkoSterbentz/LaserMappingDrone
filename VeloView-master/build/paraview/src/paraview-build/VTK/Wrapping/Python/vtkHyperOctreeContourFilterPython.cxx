...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkHyperOctreeContourFilter(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkHyperOctreeContourFilterNew(const char *); }
...
PyvtkHyperOctreeContourFilter_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkHyperOctreeContourFilter::GetClassName());
...
PyvtkHyperOctreeContourFilter_IsA(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkHyperOctreeContourFilter::IsA(temp0));
...
PyvtkHyperOctreeContourFilter_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    {
    vtkHyperOctreeContourFilter *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkHyperOctreeContourFilter::NewInstance());
...
PyvtkHyperOctreeContourFilter_SafeDownCast(PyObject *, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
    ...
    {
    vtkHyperOctreeContourFilter *tempr = vtkHyperOctreeContourFilter::SafeDownCast(temp0);
...
PyvtkHyperOctreeContourFilter_GetValue(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    double tempr = (ap.IsBound() ?
      op->GetValue(temp0) :
      op->vtkHyperOctreeContourFilter::GetValue(temp0));
...
static PyObject *
PyvtkHyperOctreeContourFilter_GetValues_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    double *tempr = (ap.IsBound() ?
      op->GetValues() :
      op->vtkHyperOctreeContourFilter::GetValues());
...
static PyObject *
PyvtkHyperOctreeContourFilter_GetValues_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetValues");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHyperOctreeContourFilter *op = static_cast<vtkHyperOctreeContourFilter *>(vp);
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkHyperOctreeContourFilter::GetValues(temp0);
      }
...
static PyObject *
PyvtkHyperOctreeContourFilter_GetValues(PyObject *self, PyObject *args)
{
  ...
  switch(nargs)
    {
    case 0:
      return PyvtkHyperOctreeContourFilter_GetValues_s1(self, args);
    case 1:
      return PyvtkHyperOctreeContourFilter_GetValues_s2(self, args);
    }
...
PyvtkHyperOctreeContourFilter_GetNumberOfContours(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHyperOctreeContourFilter::GetNumberOfContours());
...
PyvtkHyperOctreeContourFilter_GetMTime(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    unsigned long tempr = (ap.IsBound() ?
      op->GetMTime() :
      op->vtkHyperOctreeContourFilter::GetMTime());
...
PyvtkHyperOctreeContourFilter_GetLocator(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    vtkIncrementalPointLocator *tempr = (ap.IsBound() ?
      op->GetLocator() :
      op->vtkHyperOctreeContourFilter::GetLocator());
...
static PyMethodDef PyvtkHyperOctreeContourFilter_Methods[] = {
  {(char*)"GetClassName", PyvtkHyperOctreeContourFilter_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkHyperOctreeContourFilter_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkHyperOctreeContourFilter_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkHyperOctreeContourFilter\nC++: vtkHyperOctreeContourFilter *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkHyperOctreeContourFilter_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkHyperOctreeContourFilter\nC++: vtkHyperOctreeContourFilter *SafeDownCast(vtkObject* o)\n\n"},
  {(char*)"SetValue", PyvtkHyperOctreeContourFilter_SetValue, METH_VARARGS,
  ...
  {(char*)"GetValue", PyvtkHyperOctreeContourFilter_GetValue, METH_VARARGS,
   (char*)"V.GetValue(int) -> float\nC++: double GetValue(int i)\n\nGet the ith contour value.\n"},
  {(char*)"GetValues", PyvtkHyperOctreeContourFilter_GetValues, METH_VARARGS,
   (char*)"V.GetValues() -> (float, ...)\nC++: double *GetValues()\nV.GetValues([float, ...])\nC++: void GetValues(double *contourValues)\n\nGet a pointer to an array of contour values. There will be\nGetNumberOfContours() values in the list.\n"},
  {(char*)"SetNumberOfContours", PyvtkHyperOctreeContourFilter_SetNumberOfContours, METH_VARARGS,
   (char*)"V.SetNumberOfContours(int)\nC++: void SetNumberOfContours(int number)\n\nSet the number of contours to place into the list. You only\nreally need to use this method to reduce list size. The method\nSetValue() will automatically increase list size as needed.\n"},
  {(char*)"GetNumberOfContours", PyvtkHyperOctreeContourFilter_GetNumberOfContours, METH_VARARGS,
   (char*)"V.GetNumberOfContours() -> int\nC++: int GetNumberOfContours()\n\nGet the number of contours in the list of contour values.\n"},
  {(char*)"GenerateValues", PyvtkHyperOctreeContourFilter_GenerateValues, METH_VARARGS,
  ...
  {(char*)"GetMTime", PyvtkHyperOctreeContourFilter_GetMTime, METH_VARARGS,
   (char*)"V.GetMTime() -> int\nC++: unsigned long GetMTime()\n\nModified GetMTime Because we delegate to vtkContourValues\n"},
  {(char*)"SetLocator", PyvtkHyperOctreeContourFilter_SetLocator, METH_VARARGS,
   (char*)"V.SetLocator(vtkIncrementalPointLocator)\nC++: void SetLocator(vtkIncrementalPointLocator *locator)\n\nSet / get a spatial locator for merging points. By default, an\ninstance of vtkMergePoints is used.\n"},
  {(char*)"GetLocator", PyvtkHyperOctreeContourFilter_GetLocator, METH_VARARGS,
   (char*)"V.GetLocator() -> vtkIncrementalPointLocator\nC++: vtkIncrementalPointLocator *GetLocator()\n\nSet / get a spatial locator for merging points. By default, an\ninstance of vtkMergePoints is used.\n"},
  {(char*)"CreateDefaultLocator", PyvtkHyperOctreeContourFilter_CreateDefaultLocator, METH_VARARGS,
