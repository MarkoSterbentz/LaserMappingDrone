...
extern "C" { VTK_PYTHON_EXPORT void PyVTKAddFile_vtkPVEnableStackTraceSignalHandler(PyObject *, const char *); }
extern "C" { VTK_PYTHON_EXPORT PyObject *PyVTKClass_vtkPVEnableStackTraceSignalHandlerNew(const char *); }
...
static PyObject *
PyvtkPVEnableStackTraceSignalHandler_GetClassName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
    ...
    const char *tempr = (ap.IsBound() ?
      op->GetClassName() :
      op->vtkPVEnableStackTraceSignalHandler::GetClassName());
...
static PyObject *
PyvtkPVEnableStackTraceSignalHandler_CopyToStream(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPVEnableStackTraceSignalHandler::CopyToStream(temp0);
      }
...
static PyObject *
PyvtkPVEnableStackTraceSignalHandler_CopyFromStream(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(1) &&
    ...
    if (ap.IsBound())
      ...
      {
      op->vtkPVEnableStackTraceSignalHandler::CopyFromStream(temp0);
      }
...
static PyMethodDef PyvtkPVEnableStackTraceSignalHandler_Methods[] = {
  {(char*)"GetClassName", PyvtkPVEnableStackTraceSignalHandler_GetClassName, METH_VARARGS,
   (char*)"V.GetClassName() -> string\nC++: const char *GetClassName()\n\n"},
  {(char*)"IsA", PyvtkPVEnableStackTraceSignalHandler_IsA, METH_VARARGS,
   (char*)"V.IsA(string) -> int\nC++: int IsA(const char *name)\n\n"},
  {(char*)"NewInstance", PyvtkPVEnableStackTraceSignalHandler_NewInstance, METH_VARARGS,
   (char*)"V.NewInstance() -> vtkPVEnableStackTraceSignalHandler\nC++: vtkPVEnableStackTraceSignalHandler *NewInstance()\n\n"},
  {(char*)"SafeDownCast", PyvtkPVEnableStackTraceSignalHandler_SafeDownCast, METH_VARARGS | METH_STATIC,
   (char*)"V.SafeDownCast(vtkObject) -> vtkPVEnableStackTraceSignalHandler\nC++: vtkPVEnableStackTraceSignalHandler *SafeDownCast(\n    vtkObject* o)\n\n"},
  {(char*)"CopyFromObject", PyvtkPVEnableStackTraceSignalHandler_CopyFromObject, METH_VARARGS,
   (char*)"V.CopyFromObject(vtkObject)\nC++: virtual void CopyFromObject(vtkObject *)\n\nTransfer information about a single object into this object.\n"},
  {(char*)"AddInformation", PyvtkPVEnableStackTraceSignalHandler_AddInformation, METH_VARARGS,
   (char*)"V.AddInformation(vtkPVInformation)\nC++: virtual void AddInformation(vtkPVInformation *)\n\nMerge another information object.\n"},
  {(char*)"CopyToStream", PyvtkPVEnableStackTraceSignalHandler_CopyToStream, METH_VARARGS,
   (char*)"V.CopyToStream(vtkClientServerStream)\nC++: virtual void CopyToStream(vtkClientServerStream *)\n\nManage a serialized version of the information.\n"},
  {(char*)"CopyFromStream", PyvtkPVEnableStackTraceSignalHandler_CopyFromStream, METH_VARARGS,
...
PyObject *PyVTKClass_vtkPVEnableStackTraceSignalHandlerNew(const char *modulename)
{
  PyObject *cls = PyVTKClass_New(&PyvtkPVEnableStackTraceSignalHandler_StaticNew,
    PyvtkPVEnableStackTraceSignalHandler_Methods,
    "vtkPVEnableStackTraceSignalHandler", modulename,
    NULL, NULL,
    PyvtkPVEnableStackTraceSignalHandler_Doc(),
    PyVTKClass_vtkPVInformationNew(modulename));
  return cls;
}

const char **PyvtkPVEnableStackTraceSignalHandler_Doc()
{
...
{
  PyObject *o;
  o = PyVTKClass_vtkPVEnableStackTraceSignalHandlerNew(modulename);

  if (o && PyDict_SetItemString(dict, (char *)"vtkPVEnableStackTraceSignalHandler", o) != 0)
    {
    Py_DECREF(o);
    }
