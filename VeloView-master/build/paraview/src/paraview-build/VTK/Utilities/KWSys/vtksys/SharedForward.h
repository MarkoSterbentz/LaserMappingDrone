...
/*
  ...
  #define vtksys_SHARED_FORWARD_EXE_INSTALL "../lib/foo-1.2/foo-real"
...
# define KWSYS_SHARED_FORWARD_CONFIG_NAME vtksys_SHARED_FORWARD_CONFIG_NAME
#else
...
#  define KWSYS_SHARED_FORWARD_OPTION_COMMAND vtksys_SHARED_FORWARD_OPTION_COMMAND
# endif
#else
...
#  define KWSYS_SHARED_FORWARD_OPTION_PRINT vtksys_SHARED_FORWARD_OPTION_PRINT
# endif
#else
...
#  define KWSYS_SHARED_FORWARD_OPTION_LDD vtksys_SHARED_FORWARD_OPTION_LDD
# endif
#else
