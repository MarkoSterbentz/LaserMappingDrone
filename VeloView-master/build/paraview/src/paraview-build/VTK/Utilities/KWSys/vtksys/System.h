...
#ifdef __VMS
#define vtksysSystem_Shell_GetArgumentForUnix \
   vtksysSystem_Shell_UnixGA
#define vtksysSystem_Shell_GetArgumentSizeForUnix \
   vtksysSystem_Shell_UnixGAS
#define vtksysSystem_Shell_GetArgumentForWindows \
   vtksysSystem_Shell_WindowsGA
#endif
