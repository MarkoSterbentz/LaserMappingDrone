...
#include "../../../../paraview/VTK/GUISupport/Qt/vtkQtAnnotationLayersModelAdapter.h"
...
static const char qt_meta_stringdata_vtkQtAnnotationLayersModelAdapter[] = {
    "vtkQtAnnotationLayersModelAdapter\0"
};
...
const QMetaObjectExtraData vtkQtAnnotationLayersModelAdapter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject vtkQtAnnotationLayersModelAdapter::staticMetaObject = {
    { &vtkQtAbstractModelAdapter::staticMetaObject, qt_meta_stringdata_vtkQtAnnotationLayersModelAdapter,
      qt_meta_data_vtkQtAnnotationLayersModelAdapter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &vtkQtAnnotationLayersModelAdapter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtAnnotationLayersModelAdapter))
