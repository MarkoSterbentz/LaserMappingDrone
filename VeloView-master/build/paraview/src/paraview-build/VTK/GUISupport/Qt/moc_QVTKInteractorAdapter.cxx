...
#include "../../../../paraview/VTK/GUISupport/Qt/QVTKInteractorAdapter.h"
...
static const char qt_meta_stringdata_QVTKInteractorAdapter[] = {
    "QVTKInteractorAdapter\0"
};
...
const QMetaObjectExtraData QVTKInteractorAdapter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QVTKInteractorAdapter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QVTKInteractorAdapter,
      qt_meta_data_QVTKInteractorAdapter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QVTKInteractorAdapter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QVTKInteractorAdapter))
