...
#include "../../../../paraview/VTK/GUISupport/Qt/QVTKApplication.h"
...
static const char qt_meta_stringdata_QVTKApplication[] = {
    "QVTKApplication\0"
};
...
const QMetaObjectExtraData QVTKApplication::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QVTKApplication::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_QVTKApplication,
      qt_meta_data_QVTKApplication, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QVTKApplication::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QVTKApplication))
