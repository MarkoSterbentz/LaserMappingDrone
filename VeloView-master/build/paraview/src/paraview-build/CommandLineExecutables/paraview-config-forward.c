...
#define vtksys_SHARED_FORWARD_EXE_BUILD "/home/marko/research/VeloView-master/build/paraview/src/paraview-build/bin/paraview-config"
#define vtksys_SHARED_FORWARD_EXE_INSTALL "../lib/paraview-4.3/paraview-config"
